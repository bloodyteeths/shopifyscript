...
class OptimizedSheetsService {
  ...
  updateMetrics(startTime) {
    ...
    this.metrics.avgResponseTime =
      this.metrics.totalResponseTime / this.metrics.operations;
  }
  ...
  async healthCheck(tenantId = "default") {
    ...
    try {
      ...
      health.checks.connectionPool =
        poolStats.pool.size >= 0 ? "healthy" : "unhealthy";
...
export const ensureSheet = (tenantId, sheetTitle, headers) =>
  optimizedSheets.ensureSheet(tenantId, sheetTitle, headers);
