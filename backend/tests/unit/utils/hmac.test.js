...
describe('HMAC Utilities', () => {
  ...
  describe('createHMAC', () => {
    it('should create a valid HMAC signature', () => {
      const message = 'POST:adsautopilot:upsertconfig:1234567890';
    ...
    it('should create consistent signatures for the same input', () => {
      const message = 'GET:adsautopilot:config';
    ...
    it('should create different signatures for different inputs', () => {
      const message1 = 'GET:adsautopilot:config';
  ...
  describe('verifyHMAC', () => {
    ...
    it('should reject tampered messages', () => {
      const originalMessage = 'POST:adsautopilot:upsertconfig:1234567890';
  ...
  describe('Security properties', () => {
    ...
    it('should handle special characters in messages', () => {
      const specialMessage = 'POST:adsautopilot:endpoint:!@#$%^&*()';
    ...
    it('should handle unicode characters', () => {
      const unicodeMessage = 'POST:adsautopilot:测试:🚀';
