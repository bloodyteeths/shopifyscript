-- =====================================================
-- Migration 008: Website Content Extraction System (COMPLETE SAFE VERSION)
-- Created: 2025-09-28
-- Description: Comprehensive safe migration that adds ALL missing columns
-- =====================================================

-- Add ALL missing columns to website_content table if it exists
DO $$
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'website_content') THEN
        ...
        -- Metadata columns - INCLUDING last_scraped!
...
-- Now create indexes (these are safe with IF NOT EXISTS)
...
-- Now that all columns exist, recreate views
...
-- Success message
SELECT 'Migration 008: Website Content Extraction (COMPLETE SAFE) - SUCCESS' AS status;