-- =====================================================
-- Migration 010: Dashboard Views (COMPLETE)
-- Created: 2025-09-28
-- Description: Creates all missing tables and views for AI Dashboard
-- =====================================================
...
DO $$
BEGIN
    -- Add missing columns to content_extraction_log
...
-- 3. Content Insights View (Simplified)
...
-- Success message
SELECT 'Migration 010: Dashboard Views (COMPLETE) - SUCCESS!' AS status,
