...
Cypress.Commands.add(
  "step",
  (label: string, expectText: string, route?: string) => {
    globalStepCounter++;
        ...
        cy.intercept("POST", "/api/script-preview*", {
          ...
          body: {
            ...
            mutations: [
              ...
              {
                type: "CPC_CEILING",
                description: "CPC ceiling: Test Campaign → $2.50",
              },
              {
                type: "SCHEDULE_ADD",
                description: "Schedule added: Mon-Fri 9AM-5PM",
              },
              {
                type: "NEGATIVE_ADD",
                description: "5 master negatives attached",
              },
              {
                type: "RSA_VALIDATE",
                description: "RSA assets validated (30/90)",
              },
              {
                type: "AUDIENCE_ATTACH",
                description: "Audience attached in OBSERVE mode",
              },
            ],
          },
        }).as("scriptPreview");
...
Cypress.Commands.add(
  ...
  (element: string, expectedText: string) => {
...
Cypress.Commands.add(
  "verifyRetryBehavior",
  (alias: string, expectedRetries: number = 3) => {
