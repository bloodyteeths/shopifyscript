...
describe('ProofKit UI Audit & Screenshots', () => {
  ...
  it('should capture screenshots of the ProofKit interface', () => {
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-main-app-interface`, { 
      capture: 'fullPage' 
    });
    ...
    cy.get('body').then(($body) => {
      if ($body.find('input:visible').length > 0) {
        ...
        stepCounter++;
        cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-form-interaction`, { 
          capture: 'fullPage' 
        });
      }
    });
    ...
    cy.wait(3000);
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-final-overview`, { 
      capture: 'fullPage' 
    });
