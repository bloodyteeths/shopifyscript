...
describe('ProofKit Clean Interface Screenshots', () => {
  ...
  it('should capture clean ProofKit interface screenshots', () => {
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-proofkit-main-dashboard`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-autopilot-campaign-management`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-autopilot-budget-configuration`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-autopilot-objective-grow`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-insights-performance-analytics`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-insights-search-terms`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    cy.get('body').then(($body) => {
      if ($body.find('input[name="q"]').length > 0) {
        ...
        stepCounter++;
        cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-search-terms-filtering`, { 
          capture: 'fullPage',
          overwrite: true
        });
      }
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-tablet-view-responsive`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-mobile-view-responsive`, { 
      capture: 'fullPage',
      overwrite: true
    });
    ...
    stepCounter++;
    cy.screenshot(`e2e-test-results/screenshots/funnel/${stepCounter.toString().padStart(2, '0')}-complete-working-interface`, { 
      capture: 'fullPage',
      overwrite: true
    });

    cy.log(`✅ Successfully captured ${stepCounter} working ProofKit screenshots!`);
  });
});