...
console.log(`\nCurl command:`);
console.log(`curl -X POST "http://localhost:3005/api/upsertConfig?tenant=${TENANT}&sig=${encodeURIComponent(testSig)}" -H "Content-Type: application/json" -d '{"nonce":${nonce},"settings":{"TEST":"value"}}'`);