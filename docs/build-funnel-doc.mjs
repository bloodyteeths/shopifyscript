...
/**
 * Ads Autopilot AI Funnel Documentation Generator
 *
...
class FunnelDocGenerator {
   ...
   */
  async generate() {
    console.log("🔄 Generating Ads Autopilot AI Funnel E2E Guide...");
  ...
  generateMarkdown(steps) {
    ...
    let markdown = `# Ads Autopilot AI Merchant Funnel - End-to-End Guide

*Auto-generated from Cypress E2E tests on ${new Date().toLocaleDateString()}*

## Overview

This guide documents the complete Ads Autopilot AI merchant onboarding funnel, from initial app installation through first successful automation run. Each step includes:
...
*Generated by Ads Autopilot AI E2E Documentation System*  
