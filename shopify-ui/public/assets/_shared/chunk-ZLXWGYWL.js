...
function sanitizeCustomProperties(styles56) {
  const nonNullValues = Object.entries(styles56).filter(([_, value]) => value != null);
...
var Text = ({
  ...
  return /* @__PURE__ */ import_react45.default.createElement(Component4, Object.assign({
    className
  }, id && {
    id
  }), children);
...
function Spinner({
  ...
  const spinnerSVGMarkup = size2 === "large" ? /* @__PURE__ */ import_react46.default.createElement("svg", {
    viewBox: "0 0 44 44",
...
function Icon({
  ...
  const contentMarkup = {
    function: /* @__PURE__ */ import_react47.default.createElement(SourceComponent, Object.assign({
    ...
    placeholder: /* @__PURE__ */ import_react47.default.createElement("div", {
      className: styles4.Placeholder
    }),
    external: /* @__PURE__ */ import_react47.default.createElement("img", {
  ...
  return /* @__PURE__ */ import_react47.default.createElement("span", {
    className
  }, accessibilityLabel && /* @__PURE__ */ import_react47.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react48.useCallback)((event) => {
    if (disabled) {
...
function useLink() {
  return (0, import_react49.useContext)(LinkContext);
}

// ../node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = /* @__PURE__ */ (0, import_react50.memo)(/* @__PURE__ */ (0, import_react50.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return /* @__PURE__ */ import_react50.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props, {
      ref: _ref
    }));
  }
  const {
  ...
  return /* @__PURE__ */ import_react50.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? (
      ...
      /* @__PURE__ */ import_react51.default.createElement("a", commonProps, children)
    ) : /* @__PURE__ */ import_react51.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      target,
      download
    ...
    buttonMarkup = /* @__PURE__ */ import_react51.default.createElement("button", Object.assign({}, interactiveProps, {
...
// ../node_modules/@shopify/polaris/build/esm/utilities/i18n/hooks.js
function useI18n() {
  const i18n = (0, import_react52.useContext)(I18nContext);
  if (!i18n) {
...
function Button({
  ...
  const disclosureMarkup = disclosure ? /* @__PURE__ */ import_react53.default.createElement("span", {
  ...
  const iconSource = isIconSource(icon) ? /* @__PURE__ */ import_react53.default.createElement(Icon, {
    source: loading ? "placeholder" : icon
  }) : icon;
  const iconMarkup = iconSource ? /* @__PURE__ */ import_react53.default.createElement("span", {
    className: loading ? styles3.hidden : styles3.Icon
  }, iconSource) : null;
  ...
  const childMarkup = children ? /* @__PURE__ */ import_react53.default.createElement(Text, {
    as: "span",
    variant: textVariant,
    fontWeight: textFontWeight,
    key: disabled ? "text-disabled" : "text"
  }, children) : null;
  const spinnerSVGMarkup = loading ? /* @__PURE__ */ import_react53.default.createElement("span", {
    className: styles3.Spinner
  }, /* @__PURE__ */ import_react53.default.createElement(Spinner, {
    size: "small",
  ...
  const buttonMarkup = /* @__PURE__ */ import_react53.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup);
  return buttonMarkup;
}
...
// ../node_modules/@shopify/polaris/build/esm/components/Box/Box.js
var Box = /* @__PURE__ */ (0, import_react54.forwardRef)(({
  as = "div",
  background,
  borderColor,
  borderStyle,
...
var WithinContentContext = /* @__PURE__ */ (0, import_react55.createContext)(false);
...
function ShadowBevel(props) {
  ...
  const Component4 = as;
  return /* @__PURE__ */ import_react56.default.createElement(Component4, {
...
var Card = ({
  ...
  return /* @__PURE__ */ import_react57.default.createElement(WithinContentContext.Provider, {
    value: true
  }, /* @__PURE__ */ import_react57.default.createElement(ShadowBevel, {
    boxShadow: "100",
...
function Image({
  ...
  const handleLoad = (0, import_react59.useCallback)(() => {
    if (onLoad)
      onLoad();
  }, [onLoad]);
...
function Avatar({
  ...
  const i18n = useI18n();
  const isAfterInitialMount = useIsAfterInitialMount();
  const [status, setStatus] = (0, import_react60.useState)(Status.Pending);
  (0, import_react60.useEffect)(() => {
    setStatus(Status.Pending);
  }, [source]);
  const handleError = (0, import_react60.useCallback)(() => {
  ...
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? /* @__PURE__ */ import_react60.default.createElement(Image, {
  ...
  const avatarPath = /* @__PURE__ */ import_react60.default.createElement(import_react60.default.Fragment, null, /* @__PURE__ */ import_react60.default.createElement("path", {
    fill: "none",
  ...
  const avatarBody = customer || !initials ? avatarPath : /* @__PURE__ */ import_react60.default.createElement("text", {
  ...
  const svgMarkup = hasImage ? null : /* @__PURE__ */ import_react60.default.createElement("span", {
...
var WithinFilterContext = /* @__PURE__ */ (0, import_react61.createContext)(false);
...
function Badge({
  ...
  const i18n = useI18n();
  const withinFilter = (0, import_react63.useContext)(WithinFilterContext);
  ...
  let accessibilityMarkup = Boolean(accessibilityLabel) && /* @__PURE__ */ import_react63.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  }, accessibilityLabel);
  if (progress && !icon) {
    accessibilityMarkup = /* @__PURE__ */ import_react63.default.createElement("span", {
...
function useEventListener(eventName, handler, target, options) {
  const handlerRef = (0, import_react64.useRef)(handler);
  const optionsRef = (0, import_react64.useRef)(options);
  useIsomorphicLayoutEffect(() => {
...
var Spinner2 = /* @__PURE__ */ import_react65.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp,
...
function buttonFrom({
  ...
  return /* @__PURE__ */ import_react68.default.createElement(Button, Object.assign({
    key,
    onClick: onAction,
    tone,
...
function Labelled({
  ...
  const actionMarkup = action ? /* @__PURE__ */ import_react69.default.createElement("div", {
    className: styles12.Action
  }, buttonFrom(action, {
    variant: "plain"
  })) : null;
  const helpTextMarkup = helpText ? /* @__PURE__ */ import_react69.default.createElement("div", {
  ...
  const errorMarkup = error && typeof error !== "boolean" && /* @__PURE__ */ import_react69.default.createElement("div", {
    className: styles12.Error
  }, /* @__PURE__ */ import_react69.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const labelMarkup = label ? /* @__PURE__ */ import_react69.default.createElement("div", {
    className: styles12.LabelWrapper
  }, /* @__PURE__ */ import_react69.default.createElement(Label, Object.assign({
    id,
    requiredIndicator
  }, rest, {
    hidden: false
...
function useToggle(initialState) {
  const [value, setState] = (0, import_react70.useState)(initialState);
  return {
    value,
    toggle: (0, import_react70.useCallback)(() => setState((state) => !state), []),
    setTrue: (0, import_react70.useCallback)(() => setState(true), []),
    setFalse: (0, import_react70.useCallback)(() => setState(false), [])
  };
}
...
function Connected({
  ...
  const leftConnectionMarkup = left ? /* @__PURE__ */ import_react72.default.createElement(Item, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? /* @__PURE__ */ import_react72.default.createElement(Item, {
    position: "right"
  }, right) : null;
  return /* @__PURE__ */ import_react72.default.createElement("div", {
    className: styles15.Connected
  }, leftConnectionMarkup, /* @__PURE__ */ import_react72.default.createElement(Item, {
    position: "primary"
...
function Resizer({
  ...
  const minimumLinesMarkup = minimumLines ? /* @__PURE__ */ import_react73.default.createElement("div", {
...
function TextField({
  ...
  const iconPrefix = /* @__PURE__ */ import_react74.default.isValidElement(prefix) && prefix.type === Icon;
  const prefixMarkup = prefix ? /* @__PURE__ */ import_react74.default.createElement("div", {
  ...
  const suffixMarkup = suffix ? /* @__PURE__ */ import_react74.default.createElement("div", {
  ...
  const loadingMarkup = loading ? /* @__PURE__ */ import_react74.default.createElement("div", {
    className: styles11.Loading,
    id: `${id}-Loading`,
    ref: loadingRef
  }, /* @__PURE__ */ import_react74.default.createElement(Spinner, {
    size: "small"
  })) : null;
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = /* @__PURE__ */ import_react74.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? /* @__PURE__ */ import_react74.default.createElement("button", {
    type: "button",
    ...
    as: "span",
    visuallyHidden: true
  }, i18n.translate("Polaris.Common.clear")), /* @__PURE__ */ import_react74.default.createElement(Icon, {
  ...
  const spinnerMarkup = isNumericType && step !== 0 && !disabled && !readOnly ? /* @__PURE__ */ import_react74.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const resizer = multiline && isAfterInitial ? /* @__PURE__ */ import_react74.default.createElement(Resizer, {
  ...
  const input = /* @__PURE__ */ (0, import_react74.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? /* @__PURE__ */ import_react74.default.createElement("div", {
  ...
  const backdropMarkup = /* @__PURE__ */ import_react74.default.createElement("div", {
  ...
  const inputAndSuffixMarkup = autoSize ? /* @__PURE__ */ import_react74.default.createElement("div", {
  ...
  }, inputMarkup), suffixMarkup) : /* @__PURE__ */ import_react74.default.createElement(import_react74.default.Fragment, null, inputMarkup, suffixMarkup);
  return /* @__PURE__ */ import_react74.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    disabled,
    readOnly
  }, /* @__PURE__ */ import_react74.default.createElement(Connected, {
    left: connectedLeft,
...
var FilterActionsContext = /* @__PURE__ */ (0, import_react75.createContext)(false);
function FilterActionsProvider({
  children,
  filterActions
}) {
  return /* @__PURE__ */ import_react75.default.createElement(FilterActionsContext.Provider, {
    value: filterActions
  }, children);
}
...
function useEphemeralPresenceManager() {
  const ephemeralPresenceManager = (0, import_react76.useContext)(EphemeralPresenceManagerContext);
...
function usePortalsManager() {
  const portalsManager = (0, import_react77.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function ThemeProvider(props) {
  ...
  return /* @__PURE__ */ import_react78.default.createElement(ThemeNameContext.Provider, {
    value: themeName
  }, /* @__PURE__ */ import_react78.default.createElement(ThemeContext.Provider, {
    value: getTheme(themeName)
  }, /* @__PURE__ */ import_react78.default.createElement(ThemeContainer, {
...
function Portal({
  ...
  const uniqueId = (0, import_react79.useId)();
  const portalId = idPrefix !== "" ? `${idPrefix}-${uniqueId}` : uniqueId;
  (0, import_react79.useEffect)(() => {
    onPortalCreated();
  }, [onPortalCreated]);
  return container ? /* @__PURE__ */ (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react79.default.createElement(ThemeProvider, {
...
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react80.useRef)(UNIQUE_IDENTIFIER);
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react81.useRef)(false);
...
var ScrollableContext = /* @__PURE__ */ (0, import_react82.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react83.useRef)(null);
  const scrollToPosition = (0, import_react83.useContext)(ScrollableContext);
  ...
  return /* @__PURE__ */ import_react83.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var ScrollableComponent = /* @__PURE__ */ (0, import_react84.forwardRef)(({
  children,
  className,
  horizontal = true,
  vertical = true,
  ...
  const [topShadow, setTopShadow] = (0, import_react84.useState)(false);
  const [bottomShadow, setBottomShadow] = (0, import_react84.useState)(false);
  const stickyManager = useLazyRef(() => new StickyManager());
  const scrollArea = (0, import_react84.useRef)(null);
  const scrollTo = (0, import_react84.useCallback)((scrollY, options = {}) => {
  ...
  const defaultRef = (0, import_react84.useRef)();
  (0, import_react84.useImperativeHandle)(forwardedRef || defaultRef, () => ({
    scrollTo
  }));
  const handleScroll = (0, import_react84.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react84.default.createElement(ScrollableContext.Provider, {
    value: scrollTo
  }, /* @__PURE__ */ import_react84.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager.current
  }, /* @__PURE__ */ import_react84.default.createElement("div", Object.assign({
...
var PositionedOverlay = class extends import_react85.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      measuring: true,
...
// ../node_modules/@shopify/polaris/build/esm/components/Tooltip/components/TooltipOverlay/TooltipOverlay.js
var tailUpPaths = /* @__PURE__ */ import_react86.default.createElement(import_react86.default.Fragment, null, /* @__PURE__ */ import_react86.default.createElement("path", {
...
var tailDownPaths = /* @__PURE__ */ import_react86.default.createElement(import_react86.default.Fragment, null, /* @__PURE__ */ import_react86.default.createElement("path", {
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? /* @__PURE__ */ import_react86.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    }, layer.props), /* @__PURE__ */ import_react86.default.createElement("svg", {
      className: styles19.Tail,
      width: "19",
      height: "11",
      fill: "none"
    }, positioning === "above" ? tailDownPaths : tailUpPaths), /* @__PURE__ */ import_react86.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react87.useState)(null);
  const {
    presenceList,
    addPresence,
    removePresence
  ...
  const mouseEntered = (0, import_react87.useRef)(false);
  const [shouldAnimate, setShouldAnimate] = (0, import_react87.useState)(Boolean(!originalActive));
  const hoverDelayTimeout = (0, import_react87.useRef)(null);
  const hoverOutTimeout = (0, import_react87.useRef)(null);
  ...
  const handleOpen = (0, import_react87.useCallback)(() => {
  ...
  const handleKeyUp = (0, import_react87.useCallback)((event) => {
    if (event.key !== "Escape")
      return;
    handleClose?.();
    handleBlur();
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react87.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, /* @__PURE__ */ import_react87.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
...
var InlineStack = function InlineStack2({
  ...
  return /* @__PURE__ */ import_react88.default.createElement(Element2, {
...
function Item2({
  ...
  if (prefix) {
    prefixMarkup = /* @__PURE__ */ import_react89.default.createElement("span", {
      className: styles16.Prefix
    }, prefix);
  } else if (icon) {
    prefixMarkup = /* @__PURE__ */ import_react89.default.createElement("span", {
      className: styles16.Prefix
    }, /* @__PURE__ */ import_react89.default.createElement(Icon, {
      source: icon
    }));
  } else if (image) {
    prefixMarkup = /* @__PURE__ */ import_react89.default.createElement("span", {
  ...
  if (truncate && content) {
    contentText = /* @__PURE__ */ import_react89.default.createElement(TruncateText, null, content);
  } else if (ellipsis) {
    contentText = `${content}\u2026`;
  }
  const contentMarkup = helpText ? /* @__PURE__ */ import_react89.default.createElement(import_react89.default.Fragment, null, /* @__PURE__ */ import_react89.default.createElement(Box, null, contentText), /* @__PURE__ */ import_react89.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    tone: active || disabled ? void 0 : "subdued"
  }, helpText)) : /* @__PURE__ */ import_react89.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    fontWeight: active ? "semibold" : "regular"
  }, contentText);
  const badgeMarkup = badge && /* @__PURE__ */ import_react89.default.createElement("span", {
    className: styles16.Suffix
  }, /* @__PURE__ */ import_react89.default.createElement(Badge, {
    tone: badge.tone
  }, badge.content));
  const suffixMarkup = suffix && /* @__PURE__ */ import_react89.default.createElement(Box, null, /* @__PURE__ */ import_react89.default.createElement("span", {
    className: styles16.Suffix
  }, suffix));
  const textMarkup = /* @__PURE__ */ import_react89.default.createElement("span", {
  ...
  const contentElement = /* @__PURE__ */ import_react89.default.createElement(InlineStack, {
    blockAlign: "center",
    gap: "150",
    wrap: false
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const contentWrapper = /* @__PURE__ */ import_react89.default.createElement(Box, {
    width: "100%"
  }, contentElement);
  const scrollMarkup = active ? /* @__PURE__ */ import_react89.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? /* @__PURE__ */ import_react89.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentWrapper) : /* @__PURE__ */ import_react89.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return /* @__PURE__ */ import_react89.default.createElement(import_react89.default.Fragment, null, scrollMarkup, control);
}
var TruncateText = ({
  children
}) => {
  const theme = useTheme();
  const textRef = (0, import_react89.useRef)(null);
  const [isOverflowing, setIsOverflowing] = (0, import_react89.useState)(false);
  useIsomorphicLayoutEffect(() => {
    if (textRef.current) {
      setIsOverflowing(textRef.current.scrollWidth > textRef.current.offsetWidth);
    }
  }, [children]);
  const text2 = /* @__PURE__ */ import_react89.default.createElement(Text, {
    as: "span",
    truncate: true
  ...
  return isOverflowing ? /* @__PURE__ */ import_react89.default.createElement(Tooltip, {
...
function Section({
  ...
  const actionMarkup = section.items.map(({
    ...
    const itemMarkup = /* @__PURE__ */ import_react90.default.createElement(Item2, Object.assign({
      content,
      helpText,
      role: actionRole,
    ...
    }, /* @__PURE__ */ import_react90.default.createElement(InlineStack, {
      wrap: false
    }, itemMarkup));
  });
  let titleMarkup = null;
  if (section.title) {
    titleMarkup = typeof section.title === "string" ? /* @__PURE__ */ import_react90.default.createElement(Box, {
      ...
      as: "p",
      variant: "headingSm"
    }, section.title)) : /* @__PURE__ */ import_react90.default.createElement(Box, {
      padding: "200",
  ...
  const sectionMarkup = /* @__PURE__ */ import_react90.default.createElement(import_react90.default.Fragment, null, titleMarkup, /* @__PURE__ */ import_react90.default.createElement(Box, Object.assign({
    as: "div",
    padding: "150"
  }, hasMultipleSections && {
    paddingBlockStart: "0"
  ...
  }), /* @__PURE__ */ import_react90.default.createElement(BlockStack, Object.assign({
    gap: "050",
    as: "ul"
  }, sectionRole && {
    role: sectionRole
  }), actionMarkup)));
  return hasMultipleSections ? /* @__PURE__ */ import_react90.default.createElement(Box, Object.assign({
    as: "li",
    role: "presentation",
...
function KeypressListener({
  ...
  const tracked = (0, import_react91.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react91.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
function ActionList({
  ...
  const i18n = useI18n();
  const filterActions = (0, import_react92.useContext)(FilterActionsContext);
  let finalSections = [];
  const actionListRef = (0, import_react92.useRef)(null);
  const [searchText, setSearchText] = (0, import_react92.useState)("");
  if (items) {
    finalSections = [{
      items
    }, ...sections];
  ...
  const sectionMarkup = filteredSections.map((section, index) => {
    return section.items.length > 0 ? /* @__PURE__ */ import_react92.default.createElement(Section, {
  ...
  const listeners = actionRole === "menuitem" ? /* @__PURE__ */ import_react92.default.createElement(import_react92.default.Fragment, null, /* @__PURE__ */ import_react92.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.DownArrow,
    handler: handleFocusNextItem
  }), /* @__PURE__ */ import_react92.default.createElement(KeypressListener, {
    keyEvent: "keydown",
    keyCode: Key.UpArrow,
    handler: handleFocusPreviousItem
  })) : null;
  const totalFilteredActions = (0, import_react92.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react92.default.createElement(import_react92.default.Fragment, null, (allowFiltering || filterActions) && hasManyActions && isFilterable && /* @__PURE__ */ import_react92.default.createElement(Box, {
    padding: "200",
    paddingBlockEnd: totalFilteredActions > 0 ? "0" : "200"
  }, /* @__PURE__ */ import_react92.default.createElement(TextField, {
    clearButton: true,
    labelHidden: true,
    ...
    prefix: /* @__PURE__ */ import_react92.default.createElement(Icon, {
...
function wrapWithComponent(element, Component4, props) {
  ...
  return isElementOfType(element, Component4) ? element : /* @__PURE__ */ import_react93.default.createElement(Component4, props, element);
}
...
function isElementOfType(element, Component4) {
  if (element == null || !/* @__PURE__ */ (0, import_react93.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children, predicate = () => true) {
  return import_react93.Children.toArray(children).filter((child) => /* @__PURE__ */ (0, import_react93.isValidElement)(child) && predicate(child));
}
...
function Pane({
  ...
  return fixed ? /* @__PURE__ */ import_react95.default.createElement("div", {
    style,
    className
  }, content) : /* @__PURE__ */ import_react95.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom,
...
var PopoverOverlay = class extends import_react96.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = /* @__PURE__ */ (0, import_react96.createRef)();
    this.renderPopover = (overlayDetails) => {
      ...
      return /* @__PURE__ */ import_react96.default.createElement("div", Object.assign({
        className
      }, overlay.props), /* @__PURE__ */ import_react96.default.createElement(EventListener, {
        event: "click",
        handler: this.handleClick
      }), /* @__PURE__ */ import_react96.default.createElement(EventListener, {
        event: "touchstart",
        handler: this.handleClick
    ...
    this.overlayRef = /* @__PURE__ */ (0, import_react96.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react96.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
// ../node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = /* @__PURE__ */ (0, import_react97.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react97.useState)();
  ...
  const setAccessibilityAttributes = (0, import_react97.useCallback)(() => {
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react97.default.createElement(Portal, {
    idPrefix: "popover"
  }, /* @__PURE__ */ import_react97.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
    activator: activatorNode,
    preferInputActivator,
  ...
  }, import_react97.Children.only(activator), portal2);
});
...
var BannerContext = /* @__PURE__ */ (0, import_react100.createContext)(false);
...
// ../node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = /* @__PURE__ */ (0, import_react102.forwardRef)(function Banner2(props, bannerRef) {
  const {
    tone,
    stopAnnouncements
  } = props;
  const withinContentContainer = (0, import_react102.useContext)(WithinContentContext);
  const {
    wrapperRef,
    handleKeyUp,
    handleBlur,
  ...
  return /* @__PURE__ */ import_react102.default.createElement(BannerContext.Provider, {
    value: true
    ...
    onKeyUp: handleKeyUp,
    onBlur: handleBlur
  }, /* @__PURE__ */ import_react102.default.createElement(BannerLayout, props)));
});
function BannerLayout({
  ...
  const sharedBannerProps = {
    ...
    bannerTitle: title ? /* @__PURE__ */ import_react102.default.createElement(Text, {
      as: "h2",
      variant: "headingSm",
      breakWord: true
    }, title) : null,
    bannerIcon: hideIcon ? null : /* @__PURE__ */ import_react102.default.createElement("span", {
    ...
    actionButtons: action || secondaryAction ? /* @__PURE__ */ import_react102.default.createElement(ButtonGroup, null, action && /* @__PURE__ */ import_react102.default.createElement(Button, Object.assign({
      onClick: action.onAction
    }, action), action.content), secondaryAction && /* @__PURE__ */ import_react102.default.createElement(Button, Object.assign({
      onClick: secondaryAction.onAction
    }, secondaryAction), secondaryAction.content)) : null,
    dismissButton: onDismiss ? /* @__PURE__ */ import_react102.default.createElement(Button, {
      variant: "tertiary",
      icon: /* @__PURE__ */ import_react102.default.createElement("span", {
  ...
  const childrenMarkup = children ? /* @__PURE__ */ import_react102.default.createElement(Text, {
    as: "span",
    variant: "bodyMd"
  }, children) : null;
  if (withinContentContainer) {
    return /* @__PURE__ */ import_react102.default.createElement(WithinContentContainerBanner, sharedBannerProps, childrenMarkup);
  }
  if (isInlineIconBanner) {
    return /* @__PURE__ */ import_react102.default.createElement(InlineIconBanner, sharedBannerProps, childrenMarkup);
  }
  return /* @__PURE__ */ import_react102.default.createElement(DefaultBanner, sharedBannerProps, childrenMarkup);
}
function DefaultBanner({
  ...
  return /* @__PURE__ */ import_react102.default.createElement(Box, {
    width: "100%"
  }, /* @__PURE__ */ import_react102.default.createElement(BlockStack, {
    align: "space-between"
    ...
    gap: "100",
    wrap: false
  }, bannerIcon, bannerTitle), dismissButton)), hasContent && /* @__PURE__ */ import_react102.default.createElement(Box, {
    padding: {
      xs: "300",
      md: "400"
    },
    ...
    gap: "200"
  }, /* @__PURE__ */ import_react102.default.createElement("div", null, children), actionButtons))));
}
function InlineIconBanner({
  ...
  const [blockAlign, setBlockAlign] = (0, import_react102.useState)("center");
  const contentNode = (0, import_react102.useRef)(null);
  const iconNode = (0, import_react102.useRef)(null);
  const dismissIconNode = (0, import_react102.useRef)(null);
  const handleResize = (0, import_react102.useCallback)(() => {
  ...
  (0, import_react102.useEffect)(() => handleResize(), [handleResize]);
  ...
  return /* @__PURE__ */ import_react102.default.createElement(Box, {
    ...
    wrap: false,
    blockAlign
  }, bannerIcon ? /* @__PURE__ */ import_react102.default.createElement("div", {
    ref: iconNode
  }, /* @__PURE__ */ import_react102.default.createElement(Box, {
    background: backgroundColor,
    borderRadius: "200",
    padding: "100"
  }, bannerIcon)) : null, /* @__PURE__ */ import_react102.default.createElement(Box, {
    ref: contentNode,
    width: "100%"
  }, /* @__PURE__ */ import_react102.default.createElement(BlockStack, {
    gap: "200"
  }, /* @__PURE__ */ import_react102.default.createElement("div", null, children), actionButtons)))), /* @__PURE__ */ import_react102.default.createElement("div", {
    ref: dismissIconNode,
...
function WithinContentContainerBanner({
  ...
  return /* @__PURE__ */ import_react102.default.createElement(Box, {
    ...
    gap: "150",
    wrap: false
  }, bannerIcon, /* @__PURE__ */ import_react102.default.createElement(Box, {
    width: "100%"
  }, /* @__PURE__ */ import_react102.default.createElement(BlockStack, {
    gap: "200"
  }, /* @__PURE__ */ import_react102.default.createElement(BlockStack, {
    gap: "050"
  }, bannerTitle, /* @__PURE__ */ import_react102.default.createElement("div", null, children)), actionButtons))), dismissButton));
}
...
function Cell({
  ...
  const iconMarkup = /* @__PURE__ */ import_react103.default.createElement("span", {
  ...
  const sortableHeadingContent = /* @__PURE__ */ import_react103.default.createElement("button", {
  ...
  const stickyHeading = /* @__PURE__ */ import_react103.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? /* @__PURE__ */ import_react103.default.createElement("th", Object.assign({}, headerCell.props, {
    "aria-sort": sortDirection
  }, colSpanProp, {
    ref: setRef,
    className,
  ...
  }), columnHeadingContent) : /* @__PURE__ */ import_react103.default.createElement("th", Object.assign({}, colSpanProp, {
    ref: setRef,
    className,
    scope: "row",
    style: {
  ...
  }), truncate ? /* @__PURE__ */ import_react103.default.createElement(TruncatedText, {
    className: styles26.TooltipContent
  }, content) : content);
  const cellMarkup = header || firstColumn || nthColumn ? headingMarkup : /* @__PURE__ */ import_react103.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const text2 = /* @__PURE__ */ import_react103.default.createElement("span", {
    ref: textRef,
    className
  }, children);
  return current?.scrollWidth > current?.offsetWidth ? /* @__PURE__ */ import_react103.default.createElement(Tooltip, {
...
function AfterInitialMount({
  ...
  return /* @__PURE__ */ import_react105.default.createElement(import_react105.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react106.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// ../node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react107.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react107.default.createElement("div", null, /* @__PURE__ */ import_react107.default.createElement("div", {
...
function Sticky(props) {
  ...
  return /* @__PURE__ */ import_react107.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  }), pipMarkup, /* @__PURE__ */ import_react108.default.createElement(Button, {
    variant: "tertiary",
    icon: SvgChevronRightIcon,
...
var DataTableInner = class extends import_react109.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = /* @__PURE__ */ (0, import_react109.createRef)();
    this.scrollContainer = /* @__PURE__ */ (0, import_react109.createRef)();
    this.table = /* @__PURE__ */ (0, import_react109.createRef)();
    this.stickyTable = /* @__PURE__ */ (0, import_react109.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedNthColumn && inStickyHeader) {
        return [/* @__PURE__ */ import_react109.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), /* @__PURE__ */ import_react109.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = ({
      ...
      return /* @__PURE__ */ import_react109.default.createElement(Cell, {
        total: true,
        totalInFooter,
    ...
    this.defaultRenderRow = ({
      ...
      return /* @__PURE__ */ import_react109.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const headingMarkup = /* @__PURE__ */ import_react109.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedNthColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? /* @__PURE__ */ import_react109.default.createElement("tr", null, totals.map((total, index) => this.renderTotals({
      total,
      index
    }))) : null;
    ...
    const fixedNthColumnMarkup = condensed && fixedFirstColumns !== 0 && /* @__PURE__ */ import_react109.default.createElement("table", {
    ...
    }, /* @__PURE__ */ import_react109.default.createElement("thead", null, /* @__PURE__ */ import_react109.default.createElement("tr", {
      style: {
      ...
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && /* @__PURE__ */ import_react109.default.createElement("tr", {
      style: {
      ...
      total,
      index
    })))), /* @__PURE__ */ import_react109.default.createElement("tbody", null, nthColumns.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedNthColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && /* @__PURE__ */ import_react109.default.createElement("tfoot", null, /* @__PURE__ */ import_react109.default.createElement("tr", null, nthTotals?.map((total, index) => this.renderTotals({
      total,
      index
    })))));
    ...
    const footerMarkup = footerContent ? /* @__PURE__ */ import_react109.default.createElement("div", {
      className: styles26.Footer
    }, footerContent) : null;
    const paginationMarkup = pagination ? /* @__PURE__ */ import_react109.default.createElement(Pagination, Object.assign({
      type: "table"
    }, pagination)) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? /* @__PURE__ */ import_react109.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : /* @__PURE__ */ import_react109.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? /* @__PURE__ */ import_react109.default.createElement(AfterInitialMount, null, /* @__PURE__ */ import_react109.default.createElement("div", {
      className: styles26.StickyHeaderWrapper,
      role: "presentation"
    }, /* @__PURE__ */ import_react109.default.createElement(Sticky, {
      ...
      }, /* @__PURE__ */ import_react109.default.createElement("div", null, navigationMarkup("sticky")), /* @__PURE__ */ import_react109.default.createElement("table", {
    ...
    return /* @__PURE__ */ import_react109.default.createElement("div", {
      ...
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), /* @__PURE__ */ import_react109.default.createElement("div", {
      className
    ...
    }), fixedNthColumnMarkup, /* @__PURE__ */ import_react109.default.createElement("table", {
      className: styles26.Table,
      ref: this.table
    }, /* @__PURE__ */ import_react109.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), /* @__PURE__ */ import_react109.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), paginationMarkup, footerMarkup));
  }
  fixedFirstColumns() {
    const {
      hasFixedFirstColumn,
...
function DataTable(props) {
  const i18n = useI18n();
  return /* @__PURE__ */ import_react109.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
function EmptyState({
  ...
  const [imageLoaded, setImageLoaded] = (0, import_react110.useState)(false);
  const handleLoad = (0, import_react110.useCallback)(() => {
    setImageLoaded(true);
  }, []);
  const imageClassNames = classNames(styles28.Image, imageLoaded && styles28.loaded, imageContained && styles28.imageContained);
  const loadedImageMarkup = largeImage ? /* @__PURE__ */ import_react110.default.createElement(Image, {
    alt: "",
    role: "presentation",
    source: largeImage,
    ...
    onLoad: handleLoad
  }) : /* @__PURE__ */ import_react110.default.createElement(Image, {
    alt: "",
    role: "presentation",
    className: imageClassNames,
    source: image,
  ...
  const imageMarkup = /* @__PURE__ */ import_react110.default.createElement("div", {
    className: imageContainerClassNames
  }, loadedImageMarkup, /* @__PURE__ */ import_react110.default.createElement("div", {
    className: skeletonImageClassNames
  }));
  const secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, {}) : null;
  const footerContentMarkup = footerContent ? /* @__PURE__ */ import_react110.default.createElement(Box, {
  ...
  const headingMarkup = heading ? /* @__PURE__ */ import_react110.default.createElement(Box, {
    paddingBlockEnd: "150"
  }, /* @__PURE__ */ import_react110.default.createElement(Text, {
    variant: "headingMd",
    as: "p",
  ...
  const childrenMarkup = children ? /* @__PURE__ */ import_react110.default.createElement(Text, {
    as: "span",
    alignment: "center",
    variant: "bodySm"
  }, children) : null;
  const textContentMarkup = headingMarkup || children ? /* @__PURE__ */ import_react110.default.createElement(Box, {
    paddingBlockEnd: "400"
  }, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? /* @__PURE__ */ import_react110.default.createElement(InlineStack, {
    align: "center",
    gap: "200"
  }, secondaryActionMarkup, primaryActionMarkup) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? /* @__PURE__ */ import_react110.default.createElement(Box, {
    maxWidth: fullWidth ? "100%" : "400px"
  }, /* @__PURE__ */ import_react110.default.createElement(BlockStack, {
    inlineAlign: "center"
...
function getChildMapping(children, mapFn) {
  ...
  if (children)
    import_react114.Children.map(children, function(c) {
      return c;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children).forEach(function(key) {
    ...
    if (hasNext && (!hasPrev || isLeaving)) {
      children[key] = (0, import_react114.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component4 === null) {
      return /* @__PURE__ */ import_react115.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children);
    }
    return /* @__PURE__ */ import_react115.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ import_react115.default.createElement(Component4, props, children));
  };
...
function Section3({
  ...
  return /* @__PURE__ */ import_react116.default.createElement("div", {
    className
  }, /* @__PURE__ */ import_react116.default.createElement(Box, Object.assign({
    as: "section",
    padding: flush ? "0" : "400"
  }, titleHidden && {
    paddingInlineEnd: "0"
...
var FrameContext = /* @__PURE__ */ (0, import_react117.createContext)(void 0);
...
function useFocusManager({
  ...
  const focusManager = (0, import_react118.useContext)(FocusManagerContext);
  ...
  const value = (0, import_react118.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
...
var Focus = /* @__PURE__ */ (0, import_react119.memo)(function Focus2({
  children,
  disabled,
  root
}) {
  ...
  return /* @__PURE__ */ import_react119.default.createElement(import_react119.default.Fragment, null, children);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react120.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react120.useState)(true);
  ...
  return /* @__PURE__ */ import_react120.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, /* @__PURE__ */ import_react120.default.createElement("div", {
    ref: focusTrapWrapper
  }, /* @__PURE__ */ import_react120.default.createElement(EventListener, {
    event: "focusin",
...
function Dialog({
  ...
  const theme = useTheme();
  const containerNode = (0, import_react121.useRef)(null);
  const frameContext = (0, import_react121.useContext)(FrameContext);
  let toastMessages;
  if (frameContext) {
  ...
  const ariaLiveAnnouncements = /* @__PURE__ */ import_react121.default.createElement("div", {
    "aria-live": "assertive"
  }, toastMessages ? toastMessages.map((toastMessage) => /* @__PURE__ */ import_react121.default.createElement(Text, {
    visuallyHidden: true,
    as: "p",
    key: toastMessage.id
  }, toastMessage.content)) : null);
  return /* @__PURE__ */ import_react121.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    "data-polaris-overlay": true,
    ref: containerNode
  }, /* @__PURE__ */ import_react121.default.createElement(TrapFocus, null, /* @__PURE__ */ import_react121.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
...
function FadeUp({
  ...
  return /* @__PURE__ */ import_react121.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function CloseButton({
  ...
  const i18n = useI18n();
  return /* @__PURE__ */ import_react122.default.createElement(Button, {
    variant: "tertiary",
    pressed,
    icon: SvgXIcon,
    onClick,
...
function Header({
  ...
  if (titleHidden || !children) {
    return /* @__PURE__ */ import_react124.default.createElement(Box, {
      position: "absolute",
      insetInlineEnd: headerPaddingInline,
      insetBlockStart: headerPaddingBlock,
      zIndex: "1"
    }, /* @__PURE__ */ import_react124.default.createElement(CloseButton, {
      onClick: onClose
    }));
  }
  return /* @__PURE__ */ import_react124.default.createElement(Box, {
    ...
    borderColor: "border",
    background: "bg-surface-tertiary"
  }, /* @__PURE__ */ import_react124.default.createElement(InlineGrid, {
    columns: {
      xs: "1fr auto"
    },
    gap: "400"
    ...
    variant: "headingMd",
    breakWord: true
  }, children)), /* @__PURE__ */ import_react124.default.createElement(CloseButton, {
    pressed: closing,
    onClick: onClose
  })));
}
...
function useScrollLockManager() {
  const scrollLockManager = (0, import_react125.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  return /* @__PURE__ */ import_react127.default.createElement(import_react127.default.Fragment, null, /* @__PURE__ */ import_react127.default.createElement(ScrollLock, null), /* @__PURE__ */ import_react127.default.createElement("div", {
    className,
    onClick: handleClick,
    onTouchStart,
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? /* @__PURE__ */ import_react128.default.createElement(InlineStack, {
    gap: "200"
  }, secondaryActionButtons, primaryActionButton) : null;
  return /* @__PURE__ */ import_react128.default.createElement(InlineStack, {
    gap: "400",
    blockAlign: "center"
    ...
    blockAlign: "center",
    align: "space-between"
  }, /* @__PURE__ */ import_react128.default.createElement(Box, null, children), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react129.useState)(IFRAME_LOADING_HEIGHT);
  const [closing, setClosing] = (0, import_react129.useState)(false);
  const headerId = (0, import_react129.useId)();
  const activatorRef = (0, import_react129.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react129.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react129.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react129.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : /* @__PURE__ */ import_react129.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? /* @__PURE__ */ import_react129.default.createElement(Box, {
      padding: "400"
    }, /* @__PURE__ */ import_react129.default.createElement(InlineStack, {
      gap: "400",
      align: "center",
      blockAlign: "center"
    }, /* @__PURE__ */ import_react129.default.createElement(Spinner, null))) : content;
    const scrollContainerMarkup = noScroll ? /* @__PURE__ */ import_react129.default.createElement("div", {
      className: styles29.NoScrollBody
    }, /* @__PURE__ */ import_react129.default.createElement(Box, {
      width: "100%",
      overflowX: "hidden",
      overflowY: "hidden"
    }, body)) : /* @__PURE__ */ import_react129.default.createElement(Scrollable, {
      shadow: true,
      className: styles29.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? /* @__PURE__ */ import_react129.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = /* @__PURE__ */ import_react129.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      setClosing
    }, /* @__PURE__ */ import_react129.default.createElement(Header, {
      titleHidden,
      id: headerId,
      closing,
      onClose
    }, title), bodyMarkup, footerMarkup);
    backdrop = /* @__PURE__ */ import_react129.default.createElement(Backdrop, {
      setClosing,
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef2(activator) ? /* @__PURE__ */ import_react129.default.createElement(Box, {
    ref: activatorRef,
    as: activatorWrapper
  }, activator) : null;
  return /* @__PURE__ */ import_react129.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, /* @__PURE__ */ import_react129.default.createElement(Portal, {
    idPrefix: "modal"
  }, /* @__PURE__ */ import_react129.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function AnnotatedSection({
  ...
  const descriptionMarkup = typeof description === "string" ? /* @__PURE__ */ import_react131.default.createElement(Text, {
    as: "p",
    variant: "bodyMd"
  ...
  }, /* @__PURE__ */ import_react131.default.createElement(TextContainer, {
    spacing: "tight"
  }, /* @__PURE__ */ import_react131.default.createElement(Text, {
    id,
    variant: "headingMd",
    as: "h2"
  }, title), descriptionMarkup && /* @__PURE__ */ import_react131.default.createElement(Box, {
    color: "text-secondary"
  }, descriptionMarkup))), /* @__PURE__ */ import_react131.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? /* @__PURE__ */ import_react133.default.createElement(Section4, null, children) : children;
...
function Link({
  ...
  return /* @__PURE__ */ import_react134.default.createElement(BannerContext.Consumer, null, (BannerContext2) => {
    ...
    return url ? /* @__PURE__ */ import_react134.default.createElement(UnstyledLink, {
      onClick,
      className,
      url,
      external,
      ...
      "aria-label": accessibilityLabel,
      "data-primary-link": dataPrimaryLink
    }, children) : /* @__PURE__ */ import_react134.default.createElement("button", {
      type: "button",
      onClick,
      className,
      id,
...
var List = function List2({
  ...
  return /* @__PURE__ */ import_react136.default.createElement(ListElement, {
    className
  }, children);
};
List.Item = Item4;
...
function RollupActions({
  ...
  const activatorMarkup = /* @__PURE__ */ import_react142.default.createElement("div", {
  ...
  return /* @__PURE__ */ import_react142.default.createElement(Popover2, {
    ...
    hideOnPrint: true
  }, /* @__PURE__ */ import_react142.default.createElement(ActionList, {
    items,
    sections,
...
function SecondaryAction({
  ...
  const buttonMarkup = /* @__PURE__ */ import_react143.default.createElement(Button, Object.assign({
    onClick: onAction,
    tone: destructive ? "critical" : void 0
  }, rest), children);
  const actionMarkup = helpText ? /* @__PURE__ */ import_react143.default.createElement(Tooltip, {
    preferredPosition: "below",
    content: helpText
...
function MenuGroup({
  ...
  const handleClose = (0, import_react144.useCallback)(() => {
    onClose(title);
  }, [onClose, title]);
  const handleOpen = (0, import_react144.useCallback)(() => {
    onOpen(title);
  }, [onOpen, title]);
  ...
  const popoverActivator = /* @__PURE__ */ import_react144.default.createElement(SecondaryAction, {
    disclosure: true,
    disabled,
    icon,
    accessibilityLabel,
  ...
  }), details && /* @__PURE__ */ import_react144.default.createElement("div", {
...
function ActionsMeasurer({
  ...
  const i18n = useI18n();
  const containerNode = (0, import_react145.useRef)(null);
  const defaultRollupGroup = {
    title: i18n.translate("Polaris.ActionMenu.Actions.moreActions"),
    actions: []
  };
  const activator = /* @__PURE__ */ import_react145.default.createElement(SecondaryAction, {
    disclosure: true
  }, defaultRollupGroup.title);
  const handleMeasurement = (0, import_react145.useCallback)(() => {
  ...
  const actionsMarkup = actions.map((action) => {
    ...
    return /* @__PURE__ */ import_react145.default.createElement(SecondaryAction, Object.assign({
      key: content,
      onClick: onAction
    }, rest), content);
  });
  const groupsMarkup = groups.map((group) => {
    ...
    return /* @__PURE__ */ import_react145.default.createElement(SecondaryAction, {
      key: title,
      disclosure: true,
      icon
    }, title);
...
function Actions({
  ...
  const i18n = useI18n();
  const rollupActiveRef = (0, import_react146.useRef)(null);
  const [activeMenuGroup, setActiveMenuGroup] = (0, import_react146.useState)(void 0);
  const [state, setState] = (0, import_react146.useReducer)((data, partialData) => {
    return {
      ...data,
      ...partialData
    };
  ...
  const handleMenuGroupToggle = (0, import_react146.useCallback)((group) => setActiveMenuGroup(activeMenuGroup ? void 0 : group), [activeMenuGroup]);
  const handleMenuGroupClose = (0, import_react146.useCallback)(() => setActiveMenuGroup(void 0), []);
  ...
  const actionsOrDefault = (0, import_react146.useMemo)(() => actions ?? [], [actions]);
  const groupsOrDefault = (0, import_react146.useMemo)(() => groups ?? [], [groups]);
  ...
  const groupsMarkup = filteredGroups.map((group) => {
    ...
    if (!isDefaultGroup) {
      return /* @__PURE__ */ import_react146.default.createElement(MenuGroup, Object.assign({
        key: title,
        title,
  ...
  const handleMeasurement = (0, import_react146.useCallback)((measurements) => {
    const {
  ...
  const actionsMeasurer = /* @__PURE__ */ import_react146.default.createElement(ActionsMeasurer, {
    actions,
    groups,
    handleMeasurement
  });
  ...
  }, actionsMeasurer, /* @__PURE__ */ import_react146.default.createElement("div", {
...
function ActionMenu({
  ...
  }, rollup ? /* @__PURE__ */ import_react147.default.createElement(RollupActions, {
    accessibilityLabel: rollupActionsLabel,
    items: actions,
    sections: rollupSections
  }) : /* @__PURE__ */ import_react147.default.createElement(Actions, {
    actions,
    groups,
    onActionRollup
  }));
...
function useMediaQuery() {
  const mediaQuery = (0, import_react148.useContext)(MediaQueryContext);
  if (!mediaQuery) {
...
function Header2({
  ...
  const breadcrumbMarkup = backAction ? /* @__PURE__ */ import_react149.default.createElement("div", {
    className: styles39.BreadcrumbWrapper
  }, /* @__PURE__ */ import_react149.default.createElement(Box, {
    maxWidth: "100%",
    paddingInlineEnd: "100",
    printHidden: true
  }, /* @__PURE__ */ import_react149.default.createElement(Breadcrumbs, {
    backAction
  }))) : null;
  const paginationMarkup = pagination && !isNavigationCollapsed ? /* @__PURE__ */ import_react149.default.createElement("div", {
    className: styles39.PaginationWrapper
  }, /* @__PURE__ */ import_react149.default.createElement(Box, {
    printHidden: true
  }, /* @__PURE__ */ import_react149.default.createElement(Pagination, Object.assign({}, pagination, {
    hasPrevious: pagination.hasPrevious,
    hasNext: pagination.hasNext
  })))) : null;
  const pageTitleMarkup = /* @__PURE__ */ import_react149.default.createElement("div", {
    className: classNames(styles39.TitleWrapper, !hasActionGroupsOrSecondaryActions && styles39.TitleWrapperExpand)
  }, /* @__PURE__ */ import_react149.default.createElement(Title, {
    title,
    subtitle,
    titleMetadata,
    compactTitle,
  ...
  const pageReadyAccessibilityLabelMarkup = labelForPageReadyAccessibilityLabel ? /* @__PURE__ */ import_react149.default.createElement("div", {
    role: "status"
  ...
  const primaryActionMarkup = primaryAction ? /* @__PURE__ */ import_react149.default.createElement(PrimaryActionMarkup, {
    primaryAction
  }) : null;
  let actionMenuMarkup = null;
  if (isInterface(secondaryActions) && (secondaryActions.length > 0 || hasGroupsWithActions(actionGroups))) {
    actionMenuMarkup = /* @__PURE__ */ import_react149.default.createElement(ActionMenu, {
    ...
    actionMenuMarkup = /* @__PURE__ */ import_react149.default.createElement(import_react149.default.Fragment, null, secondaryActions);
  }
  const navigationMarkup = breadcrumbMarkup || paginationMarkup ? /* @__PURE__ */ import_react149.default.createElement(Box, {
    printHidden: true,
    paddingBlockEnd: "100",
    paddingInlineEnd: actionMenuMarkup && isNavigationCollapsed ? "1000" : void 0
  }, /* @__PURE__ */ import_react149.default.createElement(InlineStack, {
    gap: "400",
    align: "space-between",
    blockAlign: "center"
  }, breadcrumbMarkup, paginationMarkup)) : null;
  const additionalMetadataMarkup = additionalMetadata ? /* @__PURE__ */ import_react149.default.createElement("div", {
  ...
  const headerClassNames = classNames(isSingleRow && styles39.isSingleRow, navigationMarkup && styles39.hasNavigation, actionMenuMarkup && styles39.hasActionMenu, isNavigationCollapsed && styles39.mobileView, !backAction && styles39.noBreadcrumbs, title && title.length < LONG_TITLE && styles39.mediumTitle, title && title.length > LONG_TITLE && styles39.longTitle);
  const {
    slot1,
    slot2,
    slot3,
  ...
  }, pageReadyAccessibilityLabelMarkup, /* @__PURE__ */ import_react149.default.createElement("div", {
    className: headerClassNames
  }, /* @__PURE__ */ import_react149.default.createElement(FilterActionsProvider, {
    filterActions: Boolean(filterActions)
  }, /* @__PURE__ */ import_react149.default.createElement(ConditionalRender, {
    condition: [slot1, slot2, slot3, slot4].some(notNull)
  }, /* @__PURE__ */ import_react149.default.createElement("div", {
    className: styles39.Row
  }, slot1, slot2, /* @__PURE__ */ import_react149.default.createElement(ConditionalRender, {
    condition: [slot3, slot4].some(notNull)
  }, /* @__PURE__ */ import_react149.default.createElement("div", {
    className: styles39.RightAlign
  }, /* @__PURE__ */ import_react149.default.createElement(ConditionalWrapper, {
    condition: [slot3, slot4].every(notNull),
    wrapper: (children) => /* @__PURE__ */ import_react149.default.createElement("div", {
      className: styles39.Actions
    }, children)
  }, slot3, slot4))))), /* @__PURE__ */ import_react149.default.createElement(ConditionalRender, {
...
function PrimaryActionMarkup({
  ...
  if (isInterface(primaryAction)) {
    ...
    actionMarkup = helpText ? /* @__PURE__ */ import_react149.default.createElement(Tooltip, {
      content: helpText
    }, content) : content;
  } else {
  ...
  const layouts = {
    ...
    desktopDefault: {
      slots: {
        slot1: breadcrumbMarkup,
        slot2: pageTitleMarkup,
        slot3: /* @__PURE__ */ import_react149.default.createElement(import_react149.default.Fragment, null, actionMenuMarkup, primaryActionMarkup),
...
function Page({
  ...
  const headerMarkup = hasHeaderContent ? /* @__PURE__ */ import_react150.default.createElement(Header2, Object.assign({
    filterActions: true
  }, rest)) : null;
  return /* @__PURE__ */ import_react150.default.createElement("div", {
    className: pageClassName
  }, headerMarkup, /* @__PURE__ */ import_react150.default.createElement("div", {
    className: contentClassName
  }, children));
}
...
var ResourceListContext = /* @__PURE__ */ (0, import_react151.createContext)({});
...
var WithinListboxContext = /* @__PURE__ */ (0, import_react152.createContext)(false);
...
function Choice({
  ...
  const className = classNames(styles49.Choice, labelHidden && styles49.labelHidden, disabled && styles49.disabled, tone && styles49[variationName("tone", tone)], labelClassName);
  const labelStyle = {
  ...
  const labelMarkup = (
    ...
    }, children), /* @__PURE__ */ import_react153.default.createElement("span", {
  ...
  const helpTextMarkup = helpText ? /* @__PURE__ */ import_react153.default.createElement("div", {
  ...
  const errorMarkup = error && typeof error !== "boolean" && /* @__PURE__ */ import_react153.default.createElement("div", {
    className: styles49.Error
  }, /* @__PURE__ */ import_react153.default.createElement(InlineError, {
    message: error,
    fieldID: id
  }));
  const descriptionMarkup = helpTextMarkup || errorMarkup ? /* @__PURE__ */ import_react153.default.createElement("div", {
    className: styles49.Descriptions
  }, errorMarkup, helpTextMarkup) : null;
  return descriptionMarkup ? /* @__PURE__ */ import_react153.default.createElement("div", null, labelMarkup, descriptionMarkup) : labelMarkup;
}
...
// ../node_modules/@shopify/polaris/build/esm/components/Checkbox/Checkbox.js
var Checkbox = /* @__PURE__ */ (0, import_react154.forwardRef)(function Checkbox2({
  ariaControls,
  ...
  const id = idProp ?? uniqId;
  const isWithinListbox = (0, import_react154.useContext)(WithinListboxContext);
  (0, import_react154.useImperativeHandle)(ref, () => ({
    focus: () => {
  ...
  const wrapperClassName = classNames(styles48.Checkbox, error && styles48.error);
  ...
  const iconSource = /* @__PURE__ */ import_react154.default.createElement("svg", {
    viewBox: "0 0 16 16",
  ...
  const inputClassName = classNames(styles48.Input, isIndeterminate && styles48["Input-indeterminate"], tone && styles48[variationName("tone", tone)]);
  ...
  return /* @__PURE__ */ import_react154.default.createElement(Choice, Object.assign({
    ...
    className: wrapperClassName
  }, /* @__PURE__ */ import_react154.default.createElement("input", Object.assign({
    ref: inputNode,
    id,
    name,
    value,
  ...
  }, indeterminateAttributes)), /* @__PURE__ */ import_react154.default.createElement("span", {
  ...
  }, isIndeterminate ? /* @__PURE__ */ import_react154.default.createElement(Icon, {
    source: SvgMinusIcon
  }) : iconSource)));
});
function noop6() {
...
// ../node_modules/@shopify/polaris/build/esm/components/ResourceItem/ResourceItem.js
var BaseResourceItem = class extends import_react155.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.node = null;
    this.overlayRef = /* @__PURE__ */ (0, import_react155.createRef)();
    this.buttonOverlay = /* @__PURE__ */ (0, import_react155.createRef)();
    this.setNode = (node) => {
      this.node = node;
    };
    this.handleFocus = (event) => {
  ...
  render() {
    ...
    if (selectable) {
      ...
      handleMarkup = /* @__PURE__ */ import_react155.default.createElement("div", {
        className: styles47.CheckboxWrapper,
        onClick: stopPropagation2,
        onChange: this.handleLargerSelectionArea
      }, /* @__PURE__ */ import_react155.default.createElement(UseId, null, (id) => /* @__PURE__ */ import_react155.default.createElement(Checkbox, {
        id,
        ...
        bleedBlockEnd: "300",
        fill: true,
        labelClassName: styles47.CheckboxLabel
      })));
    }
    if (media || selectable) {
      ownedMarkup = /* @__PURE__ */ import_react155.default.createElement(InlineStack, {
        gap: "300",
        blockAlign: media && selectable ? "center" : getAlignment(verticalAlignment)
      }, handleMarkup, media);
    }
    const className = classNames(styles47.ResourceItem, focused && styles47.focused, selectable && styles47.selectable, selected && styles47.selected, selectMode && styles47.selectMode, persistActions && styles47.persistActions, focusedInner && styles47.focusedInner, disabled && styles47.disabled);
    const listItemClassName = classNames(styles47.ListItem, focused && !focusedInner && styles47.focused, hasBulkActions && styles47.hasBulkActions, selected && styles47.selected, selectable && styles47.selectable);
    let actionsMarkup = null;
    let disclosureMarkup = null;
    if (shortcutActions && !loading) {
      if (persistActions) {
        actionsMarkup = breakpoints2?.lgUp ? /* @__PURE__ */ import_react155.default.createElement("div", {
          className: styles47.Actions,
          onClick: stopPropagation2
        }, /* @__PURE__ */ import_react155.default.createElement(ButtonGroup, null, buttonsFrom(shortcutActions, {
          variant: "tertiary"
        }))) : null;
        const disclosureAccessibilityLabel = name ? i18n.translate("Polaris.ResourceList.Item.actionsDropdownLabel", {
          accessibilityLabel: name
        }) : i18n.translate("Polaris.ResourceList.Item.actionsDropdown");
        disclosureMarkup = !selectMode && breakpoints2?.lgDown ? /* @__PURE__ */ import_react155.default.createElement("div", {
          onClick: stopPropagation2
        }, /* @__PURE__ */ import_react155.default.createElement(Popover2, {
          activator: /* @__PURE__ */ import_react155.default.createElement(Button, {
        ...
        actionsMarkup = /* @__PURE__ */ import_react155.default.createElement("div", {
          className: styles47.Actions,
          onClick: stopPropagation2
          ...
          insetBlockStart: "400",
          insetInlineEnd: "500"
        }, /* @__PURE__ */ import_react155.default.createElement(ButtonGroup, {
          variant: "segmented"
    ...
    const containerMarkup = /* @__PURE__ */ import_react155.default.createElement(Box, {
      id: this.props.id,
      position: "relative",
      paddingInlineStart: "300",
      paddingInlineEnd: "300",
    ...
    }, /* @__PURE__ */ import_react155.default.createElement(InlineGrid, {
      columns: {
        xs: "1fr auto"
      }
    }, /* @__PURE__ */ import_react155.default.createElement(InlineGrid, {
    ...
    const accessibleMarkup = url ? /* @__PURE__ */ import_react155.default.createElement(UseId, null, (id) => /* @__PURE__ */ import_react155.default.createElement(UnstyledLink, {
      ...
      id,
      ref: this.overlayRef
    })) : /* @__PURE__ */ import_react155.default.createElement("button", {
...
function ResourceItem(props) {
  const breakpoints2 = useBreakpoints();
  return /* @__PURE__ */ import_react155.default.createElement(BaseResourceItem, Object.assign({}, props, {
    breakpoints: breakpoints2,
    context: (0, import_react155.useContext)(ResourceListContext),
    i18n: useI18n()
  }));
}
...
function Select({
  ...
  const handleFocus = (0, import_react156.useCallback)((event) => {
    toggleFocused();
    onFocus?.(event);
  }, [onFocus, toggleFocused]);
  const handleBlur = (0, import_react156.useCallback)((event) => {
    toggleFocused();
    onBlur?.(event);
  ...
  const inlineLabelMarkup = labelInline && /* @__PURE__ */ import_react156.default.createElement(Box, {
    paddingInlineEnd: "100"
  ...
  const prefixMarkup = selectedOption.prefix && /* @__PURE__ */ import_react156.default.createElement("div", {
    className: styles50.Prefix
  }, selectedOption.prefix);
  const contentMarkup = /* @__PURE__ */ import_react156.default.createElement("div", {
    className: styles50.Content,
    "aria-hidden": true,
    "aria-disabled": disabled
  }, inlineLabelMarkup, prefixMarkup, /* @__PURE__ */ import_react156.default.createElement("span", {
    className: styles50.SelectedOption
  }, selectedOption.label), /* @__PURE__ */ import_react156.default.createElement("span", {
    className: styles50.Icon
  }, /* @__PURE__ */ import_react156.default.createElement(Icon, {
    source: SvgSelectIcon
  })));
  const optionsMarkup = normalizedOptions.map(renderOption);
  return /* @__PURE__ */ import_react156.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    "aria-describedby": describedBy.length ? describedBy.join(" ") : void 0,
    "aria-required": requiredIndicator
  }, optionsMarkup), contentMarkup, /* @__PURE__ */ import_react156.default.createElement("div", {
...
function renderSingleOption(option) {
  ...
  return /* @__PURE__ */ import_react156.default.createElement("option", Object.assign({
    key: key ?? value,
    value
  }, rest), label);
}
function renderOption(optionOrGroup) {
  if (isGroup(optionOrGroup)) {
    ...
    return /* @__PURE__ */ import_react156.default.createElement("optgroup", {
      label: title,
      key: title
...
// ../node_modules/@shopify/polaris/build/esm/components/CheckableButton/CheckableButton.js
var CheckableButton = /* @__PURE__ */ (0, import_react157.forwardRef)(function CheckableButton2({
  accessibilityLabel,
  label = "",
  onToggleAll,
  selected,
  ...
  const checkBoxRef = (0, import_react157.useRef)(null);
  function focus() {
    checkBoxRef?.current?.focus();
  }
  (0, import_react157.useImperativeHandle)(ref, () => {
    return {
      focus
    };
  });
  return /* @__PURE__ */ import_react157.default.createElement("div", {
  ...
  }, /* @__PURE__ */ import_react157.default.createElement(Checkbox, {
    label: accessibilityLabel,
    labelHidden: true,
    checked: selected,
    disabled,
    ...
    ref: checkBoxRef
  })), label ? /* @__PURE__ */ import_react157.default.createElement("span", {
...
// ../node_modules/@shopify/polaris/build/esm/components/LegacyStack/LegacyStack.js
var LegacyStack = /* @__PURE__ */ (0, import_react159.memo)(function Stack({
  children,
  vertical,
  spacing,
  distribution,
  ...
  const className = classNames(styles53.LegacyStack, vertical && styles53.vertical, spacing && styles53[variationName("spacing", spacing)], distribution && styles53[variationName("distribution", distribution)], alignment && styles53[variationName("alignment", alignment)], wrap === false && styles53.noWrap);
...
function Indicator({
  ...
  return /* @__PURE__ */ import_react161.default.createElement("span", {
    className
  });
}
...
function BulkActionButton({
  ...
  const bulkActionButton = (0, import_react162.useRef)(null);
  useComponentDidMount(() => {
  ...
  const buttonMarkup = /* @__PURE__ */ import_react162.default.createElement(Button, {
    external,
    url,
    ...
    disabled,
    size: size2,
    icon: isActivatorForMoreActionsPopover ? /* @__PURE__ */ import_react162.default.createElement(Icon, {
  ...
  }, isActivatorForMoreActionsPopover ? /* @__PURE__ */ import_react162.default.createElement(Tooltip, {
    content,
    preferredPosition: "below"
  }, buttonMarkup) : buttonMarkup, indicator && /* @__PURE__ */ import_react162.default.createElement(Indicator, null));
}
...
function BulkActionMenu({
  ...
  return /* @__PURE__ */ import_react163.default.createElement(import_react163.default.Fragment, null, /* @__PURE__ */ import_react163.default.createElement(Popover2, {
    active: isVisible,
    activator: /* @__PURE__ */ import_react163.default.createElement(BulkActionButton, {
      disclosure: true,
    ...
    preferInputActivator: true
  }, /* @__PURE__ */ import_react163.default.createElement(ActionList, {
    items: actions,
...
function BulkActionsMeasurer({
  ...
  const i18n = useI18n();
  const containerNode = (0, import_react164.useRef)(null);
  const activatorLabel = i18n.translate("Polaris.ResourceList.BulkActions.moreActionsActivatorLabel");
  const activator = /* @__PURE__ */ import_react164.default.createElement(BulkActionButton, {
    disclosure: true,
    content: activatorLabel
  });
  const handleMeasurement = (0, import_react164.useCallback)(() => {
    if (!containerNode.current) {
      return;
    }
    const containerWidth = containerNode.current.offsetWidth;
  ...
  const promotedActionsMarkup = promotedActions.map((action, index) => {
    if (instanceOfMenuGroupDescriptor(action)) {
      return /* @__PURE__ */ import_react164.default.createElement(BulkActionButton, {
        key: index,
        disclosure: true,
        showContentInButton: true,
    ...
    return /* @__PURE__ */ import_react164.default.createElement(BulkActionButton, Object.assign({
      key: index,
      disabled
    }, action, {
      size: buttonSize
...
// ../node_modules/@shopify/polaris/build/esm/components/BulkActions/BulkActions.js
var BulkActions = /* @__PURE__ */ (0, import_react165.forwardRef)(function BulkActions2({
  promotedActions,
  actions,
  disabled,
  buttonSize,
  ...
  const [state, setState] = (0, import_react165.useReducer)((data, partialData) => {
    return {
      ...data,
      ...partialData
    };
  ...
  const paginatedSelectAllMarkup = paginatedSelectAllAction ? /* @__PURE__ */ import_react165.default.createElement(UnstyledButton, {
  ...
  const togglePopover = (0, import_react165.useCallback)(() => {
    onMoreActionPopoverToggle?.(popoverActive);
    setPopoverActive((popoverActive2) => !popoverActive2);
  }, [onMoreActionPopoverToggle, popoverActive]);
  const handleMeasurement = (0, import_react165.useCallback)((measurements) => {
    const {
      hiddenActionsWidths: actionsWidths2,
      containerWidth: containerWidth2,
      disclosureWidth: disclosureWidth2
  ...
  const promotedActionsMarkup = promotedActions ? promotedActions.filter((_, index) => {
    ...
    if (instanceOfMenuGroupDescriptor(action)) {
      return /* @__PURE__ */ import_react165.default.createElement(BulkActionMenu, Object.assign({
        key: index
      }, action, {
  ...
  const allHiddenActions = (0, import_react165.useMemo)(() => {
    if (actionSections) {
  ...
  const actionsMarkup = allHiddenActions.length > 0 ? /* @__PURE__ */ import_react165.default.createElement(Popover2, {
  ...
  const measurerMarkup = /* @__PURE__ */ import_react165.default.createElement(BulkActionsMeasurer, {
    promotedActions,
    disabled,
    buttonSize,
    handleMeasurement
  ...
  }, /* @__PURE__ */ import_react165.default.createElement(InlineStack, {
    gap: "400",
    blockAlign: "center"
  }, /* @__PURE__ */ import_react165.default.createElement("div", {
    className: styles54.BulkActionsSelectAllWrapper
  }, /* @__PURE__ */ import_react165.default.createElement(CheckableButton, checkableButtonProps), paginatedSelectAllMarkup), selectMode ? /* @__PURE__ */ import_react165.default.createElement("div", {
  ...
  }, measurerMarkup, /* @__PURE__ */ import_react165.default.createElement("div", {
...
function ResourceList({
  ...
  const i18n = useI18n();
  const [selectMode, setSelectMode] = (0, import_react166.useState)(Boolean(selectedItems && selectedItems.length > 0));
  const [loadingPosition, setLoadingPositionState] = (0, import_react166.useState)(0);
  const [lastSelected, setLastSelected] = (0, import_react166.useState)();
  const [smallScreen, setSmallScreen] = (0, import_react166.useState)(isBreakpointsXS());
  const forceUpdate = (0, import_react166.useReducer)((x = 0) => x + 1, 0)[1];
  const checkableButtonRef = (0, import_react166.useRef)(null);
  const defaultResourceName = useLazyRef(() => ({
    singular: i18n.translate("Polaris.ResourceList.defaultItemSingular"),
    plural: i18n.translate("Polaris.ResourceList.defaultItemPlural")
  }));
  const listRef = (0, import_react166.useRef)(null);
  ...
  const selectAllSelectState = (0, import_react166.useMemo)(() => {
  ...
  const [selectedItemsCount, setSelectedItemsCount] = (0, import_react166.useState)(selectedItems === SELECT_ALL_ITEMS ? `${items.length}+` : selectedItems.length);
  ...
  const bulkActionsAccessibilityLabel = (0, import_react166.useMemo)(() => {
  ...
  const paginatedSelectAllText = (0, import_react166.useMemo)(() => {
  ...
  const handleSelectAllItemsInStore = (0, import_react166.useCallback)(() => {
  ...
  const paginatedSelectAllAction = (0, import_react166.useMemo)(() => {
    if (!isSelectable || !hasMoreItems) {
      return;
    }
  ...
  const setLoadingPosition = (0, import_react166.useCallback)(() => {
  ...
  const bulkActionsMarkup = isSelectable ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className: bulkActionClassNames
  }, /* @__PURE__ */ import_react166.default.createElement(BulkActions, {
    selectMode,
  ...
  const filterControlMarkup = filterControl ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className: classNames(!flushFilters && styles51.FiltersWrapper)
  }, filterControl) : null;
  const sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.SortWrapper
  }, /* @__PURE__ */ import_react166.default.createElement(Select, {
  ...
  const alternateToolMarkup = alternateTool && !sortingSelectMarkup ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.AlternateToolWrapper
  }, alternateTool) : null;
  const headerTitleMarkup = /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.HeaderTitleWrapper
  }, /* @__PURE__ */ import_react166.default.createElement(Text, {
    as: "span",
    variant: "bodyMd"
  }, headerTitle()));
  const selectButtonMarkup = isSelectable ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.SelectButtonWrapper
  }, /* @__PURE__ */ import_react166.default.createElement(Button, {
    disabled: selectMode,
    icon: SvgCheckboxIcon,
    onClick: () => handleSelectMode(true)
  }, i18n.translate("Polaris.ResourceList.selectButtonText"))) : null;
  const checkableButtonMarkup = isSelectable ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.CheckableButtonWrapper
  }, /* @__PURE__ */ import_react166.default.createElement(CheckableButton, {
    accessibilityLabel: bulkActionsAccessibilityLabel,
    label: headerTitle(),
    onToggleAll: handleToggleAll,
    disabled: loading,
  ...
  const headerWrapperOverlay = loading ? /* @__PURE__ */ import_react166.default.createElement("div", {
  ...
  const headerMarkup = !showEmptyState && showHeader !== false && !showEmptySearchState && (showHeader || needsHeader) && listRef.current && /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.HeaderOuterWrapper
  }, /* @__PURE__ */ import_react166.default.createElement(Sticky, {
    ...
    return /* @__PURE__ */ import_react166.default.createElement("div", {
      className: headerClassName
    }, headerWrapperOverlay, /* @__PURE__ */ import_react166.default.createElement("div", {
  ...
  const emptySearchStateMarkup = showEmptySearchState ? emptySearchState || /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.EmptySearchResultWrapper
  }, /* @__PURE__ */ import_react166.default.createElement(EmptySearchResult, Object.assign({}, emptySearchResultText, {
  ...
  const loadingOverlay = loading ? /* @__PURE__ */ import_react166.default.createElement(import_react166.default.Fragment, null, /* @__PURE__ */ import_react166.default.createElement("li", {
    className: styles51.SpinnerContainer,
    style: spinnerStyle
  }, /* @__PURE__ */ import_react166.default.createElement(Spinner, {
    size: spinnerSize,
    accessibilityLabel: "Items are loading"
  })), /* @__PURE__ */ import_react166.default.createElement("li", {
    className: styles51.LoadingOverlay
  })) : null;
  const className = classNames(styles51.ItemWrapper, loading && styles51["ItemWrapper-isLoading"]);
  const loadingWithoutItemsMarkup = loading && !itemsExist ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className,
    tabIndex: -1
  }, loadingOverlay) : null;
  ...
  const listMarkup = itemsExist ? /* @__PURE__ */ import_react166.default.createElement("ul", {
    className: resourceListClassName,
    ref: listRef,
    "aria-live": "polite",
    "aria-busy": loading
  }, loadingOverlay, import_react166.Children.toArray(items.map(renderItemWithId))) : null;
  const paginationMarkup = pagination ? /* @__PURE__ */ import_react166.default.createElement("div", {
    className: styles51.PaginationWrapper
  }, /* @__PURE__ */ import_react166.default.createElement(Pagination, Object.assign({
    type: "table"
  }, pagination))) : null;
  const context = {
  ...
  return /* @__PURE__ */ import_react166.default.createElement(ResourceListContext.Provider, {
    value: context
  }, filterControlMarkup, /* @__PURE__ */ import_react166.default.createElement("div", {
...
//# sourceMappingURL=/assets/_shared/chunk-ZLXWGYWL.js.map
