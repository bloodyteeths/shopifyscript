...
function sanitizeCustomProperties(styles63) {
  const nonNullValues = Object.entries(styles63).filter(([_, value]) => value != null);
...
var Text = ({
  ...
  const Component5 = as || (visuallyHidden ? "span" : "p");
  ...
  return /* @__PURE__ */ import_react47.default.createElement(Component5, Object.assign({
    className
  }, id && {
    id
  }), children);
...
function ShadowBevel(props) {
  ...
  const Component5 = as;
  return /* @__PURE__ */ import_react58.default.createElement(Component5, {
...
function wrapWithComponent(element, Component5, props) {
  ...
  return isElementOfType(element, Component5) ? element : /* @__PURE__ */ import_react95.default.createElement(Component5, props, element);
}
...
function isElementOfType(element, Component5) {
  ...
  const Components = Array.isArray(Component5) ? Component5 : [Component5];
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react117.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ import_react117.default.createElement(Component5, props, children));
  };
...
var BulkActions = /* @__PURE__ */ (0, import_react167.forwardRef)(function BulkActions2({
  ...
  const mergedHiddenPromotedActions = hiddenPromotedActionObjects.reduce((memo5, action) => {
    if (!action)
      return memo5;
    if (instanceOfMenuGroupDescriptor(action)) {
      return memo5.concat(action.actions);
    }
    return memo5.concat(action);
  }, []);
  ...
  const allHiddenActions = (0, import_react167.useMemo)(() => {
    ...
    return actions.filter((action) => action).reduce((memo5, action) => {
      ...
      if (isAFlatArray) {
        ...
        const lastItem = memo5[memo5.length - 1];
        memo5.splice(memo5.length - 1, 1, {
...
function RadioButton({
  ...
  const uniqId = (0, import_react169.useId)();
  const id = idProp ?? uniqId;
  const name = nameProp || id;
  const inputNode = (0, import_react169.useRef)(null);
  const handleBlur = () => {
    onBlur && onBlur();
  };
  ...
  const ariaDescribedBy = describedBy.length ? describedBy.join(" ") : void 0;
  const inputClassName = classNames(styles57.Input, tone && styles57[variationName("tone", tone)]);
  const extraChoiceProps = {
    helpText,
    bleed,
    bleedBlockStart,
  ...
  return /* @__PURE__ */ import_react169.default.createElement(Choice, Object.assign({
    label,
    labelHidden,
    disabled,
    id,
    ...
    tone
  } : {}), /* @__PURE__ */ import_react169.default.createElement("span", {
    className: styles57.RadioButton
  }, /* @__PURE__ */ import_react169.default.createElement("input", {
    id,
    name,
    value,
    type: "radio",
...
function ChoiceList({
  ...
  const uniqName = (0, import_react170.useId)();
  const name = nameProp ?? uniqName;
  const finalName = allowMultiple ? `${name}[]` : name;
  const titleMarkup = title ? /* @__PURE__ */ import_react170.default.createElement(Box, {
    as: "legend",
    paddingBlockEnd: {
      xs: "0",
      md: "100"
  ...
  const choicesMarkup = choices.map((choice) => {
    ...
    const children = renderedChildren ? /* @__PURE__ */ import_react170.default.createElement("div", {
    ...
    return /* @__PURE__ */ import_react170.default.createElement("li", {
      key: value
    }, /* @__PURE__ */ import_react170.default.createElement(Bleed, {
    ...
    }, /* @__PURE__ */ import_react170.default.createElement(ControlComponent, {
      name: finalName,
      value,
      id,
      label,
  ...
  const errorMarkup = error && /* @__PURE__ */ import_react170.default.createElement(Box, {
    paddingBlockStart: {
      xs: "0",
      md: "100"
    },
    paddingBlockEnd: "200"
  }, /* @__PURE__ */ import_react170.default.createElement(InlineError, {
    message: error,
    fieldID: finalName
  }));
  return /* @__PURE__ */ import_react170.default.createElement(BlockStack, {
    as: "fieldset",
    gap: {
      xs: "400",
      md: "0"
    ...
    "aria-invalid": error != null,
    id: finalName
  }, titleMarkup, /* @__PURE__ */ import_react170.default.createElement(BlockStack, {
    as: "ul",
    gap: {
      xs: "400",
      md: "0"
...
function Item6({
  ...
  const className = classNames(styles58.Item, condensed ? styles58.condensed : styles58.grouped);
  return children ? /* @__PURE__ */ import_react171.default.createElement("div", {
    className
  }, children) : null;
}
...
function Group({
  ...
  const id = (0, import_react172.useId)();
  ...
  if (helpText) {
    ...
    helpTextElement = /* @__PURE__ */ import_react172.default.createElement(Box, {
      id: helpTextId,
      color: "text-secondary"
    }, helpText);
  }
  if (title) {
    titleId = `${id}Title`;
    titleElement = /* @__PURE__ */ import_react172.default.createElement(Text, {
      id: titleId,
      as: "p"
    }, title);
  }
  const itemsMarkup = import_react172.Children.map(children, (child) => wrapWithComponent(child, Item6, {
    condensed
  }));
  ...
  }, titleElement, /* @__PURE__ */ import_react172.default.createElement(InlineStack, {
    gap: "300"
  }, itemsMarkup), helpTextElement);
}

// ../node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = /* @__PURE__ */ (0, import_react173.memo)(function FormLayout2({
  children
}) {
  return /* @__PURE__ */ import_react173.default.createElement(BlockStack, {
    gap: "400"
  }, import_react173.Children.map(children, wrapChildren));
});
...
function Cell2({
  ...
  const className = classNames(styles60.Cell, columnSpan?.xs && styles60[`Cell-${columnSpan.xs}-column-xs`], columnSpan?.sm && styles60[`Cell-${columnSpan.sm}-column-sm`], columnSpan?.md && styles60[`Cell-${columnSpan.md}-column-md`], columnSpan?.lg && styles60[`Cell-${columnSpan.lg}-column-lg`], columnSpan?.xl && styles60[`Cell-${columnSpan.xl}-column-xl`]);
  const style = {
    gridArea,
...
var DualThumb = class extends import_react176.Component {
  constructor(...args) {
    super(...args);
    this.state = {
    ...
    this.track = /* @__PURE__ */ (0, import_react176.createRef)();
    this.trackWrapper = /* @__PURE__ */ (0, import_react176.createRef)();
    this.thumbLower = /* @__PURE__ */ (0, import_react176.createRef)();
    this.thumbUpper = /* @__PURE__ */ (0, import_react176.createRef)();
  ...
  render() {
    ...
    const ariaDescribedBy = describedBy.length ? describedBy.join(" ") : void 0;
    const trackWrapperClassName = classNames(styles61.TrackWrapper, error && styles61.error, disabled && styles61.disabled);
    const thumbLowerClassName = classNames(styles61.Thumbs, styles61.ThumbLower, disabled && styles61.disabled);
    const thumbUpperClassName = classNames(styles61.Thumbs, styles61.ThumbUpper, disabled && styles61.disabled);
    ...
    const outputLowerClassName = classNames(styles61.Output, styles61.OutputLower);
    const outputMarkupLower = !disabled && output ? /* @__PURE__ */ import_react176.default.createElement("output", {
      htmlFor: idLower,
      ...
      className: styles61.OutputBubble
    }, /* @__PURE__ */ import_react176.default.createElement(Text, {
      as: "span",
      variant: "headingSm",
      alignment: "center"
    }, value[0]))) : null;
    const outputUpperClassName = classNames(styles61.Output, styles61.OutputUpper);
    const outputMarkupUpper = !disabled && output ? /* @__PURE__ */ import_react176.default.createElement("output", {
      htmlFor: idUpper,
    ...
    const prefixMarkup = prefix && /* @__PURE__ */ import_react176.default.createElement("div", {
      className: styles61.Prefix
    }, prefix);
    const suffixMarkup = suffix && /* @__PURE__ */ import_react176.default.createElement("div", {
      className: styles61.Suffix
    }, suffix);
    return /* @__PURE__ */ import_react176.default.createElement(import_react176.default.Fragment, null, /* @__PURE__ */ import_react176.default.createElement(Labelled, {
      id,
      label,
      error,
      action: labelAction,
      ...
      className: classNames(styles61.DualThumb, sharedStyles.RangeSlider)
    }, prefixMarkup, /* @__PURE__ */ import_react176.default.createElement("div", {
      className: trackWrapperClassName,
      onMouseDown: this.handleMouseDownTrack,
      ref: this.trackWrapper
    }, /* @__PURE__ */ import_react176.default.createElement("div", {
      className: styles61.Track,
      style: cssVars,
      ref: this.track
    }), /* @__PURE__ */ import_react176.default.createElement("div", {
      ...
      ref: this.thumbLower
    }), outputMarkupLower, /* @__PURE__ */ import_react176.default.createElement("div", {
      id: idUpper,
      ...
      ref: this.thumbUpper
    }), outputMarkupUpper), suffixMarkup)), /* @__PURE__ */ import_react176.default.createElement(EventListener, {
      event: "resize",
...
function SingleThumb(props) {
  ...
  const outputMarkup = !disabled && output && /* @__PURE__ */ import_react177.default.createElement("output", {
    htmlFor: id,
    className: styles62.Output
  }, /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles62.OutputBubble
  }, /* @__PURE__ */ import_react177.default.createElement(Text, {
    as: "span",
    variant: "headingSm",
    alignment: "center"
  }, clampedValue)));
  const prefixMarkup = prefix && /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles62.Prefix
  }, prefix);
  const suffixMarkup = suffix && /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles62.Suffix
  }, suffix);
  const className = classNames(styles62.SingleThumb, sharedStyles.RangeSlider, error && styles62.error, disabled && styles62.disabled);
  return /* @__PURE__ */ import_react177.default.createElement(Labelled, {
    id,
    label,
    error,
    action: labelAction,
    ...
    className,
    style: cssVars
  }, prefixMarkup, /* @__PURE__ */ import_react177.default.createElement("div", {
    className: classNames(styles62.InputWrapper, sharedStyles["Track--dashed-after"])
  }, /* @__PURE__ */ import_react177.default.createElement("input", {
    type: "range",
    className: styles62.Input,
    id,
    name: id,
    min,
    max,
...
function RangeSlider({
  ...
  return isDualThumb(value) ? /* @__PURE__ */ import_react178.default.createElement(DualThumb, Object.assign({
    value
  }, sharedProps)) : /* @__PURE__ */ import_react178.default.createElement(SingleThumb, Object.assign({
    value
  }, sharedProps));
}
...
//# sourceMappingURL=/assets/_shared/chunk-5UXC3ZLW.js.map
