...
function sanitizeCustomProperties(styles62) {
  const nonNullValues = Object.entries(styles62).filter(([_, value]) => value != null);
...
var Text = ({
  ...
  return /* @__PURE__ */ import_react49.default.createElement(Component4, Object.assign({
    className
  }, id && {
    id
  }), children);
...
function Spinner({
  ...
  const spinnerSVGMarkup = size2 === "large" ? /* @__PURE__ */ import_react50.default.createElement("svg", {
    viewBox: "0 0 44 44",
...
function useDisableClick(disabled, handleClick) {
  const handleClickWrapper = (0, import_react52.useCallback)((event) => {
    if (disabled) {
...
function useLink() {
  return (0, import_react53.useContext)(LinkContext);
}

// ../node_modules/@shopify/polaris/build/esm/components/UnstyledLink/UnstyledLink.js
var UnstyledLink = /* @__PURE__ */ (0, import_react54.memo)(/* @__PURE__ */ (0, import_react54.forwardRef)(function UnstyledLink2(props, _ref) {
  const LinkComponent = useLink();
  if (LinkComponent) {
    return /* @__PURE__ */ import_react54.default.createElement(LinkComponent, Object.assign({}, unstyled.props, props, {
      ref: _ref
    }));
  }
  const {
  ...
  return /* @__PURE__ */ import_react54.default.createElement("a", Object.assign({
    target
  }, rest, {
    href: url,
    rel
...
function UnstyledButton({
  ...
  if (url) {
    buttonMarkup = disabled ? (
      ...
      /* @__PURE__ */ import_react55.default.createElement("a", commonProps, children)
    ) : /* @__PURE__ */ import_react55.default.createElement(UnstyledLink, Object.assign({}, interactiveProps, {
      url,
      external,
      target,
      download
    ...
    buttonMarkup = /* @__PURE__ */ import_react55.default.createElement("button", Object.assign({}, interactiveProps, {
...
function Button({
  ...
  const childMarkup = children ? /* @__PURE__ */ import_react57.default.createElement(Text, {
    as: "span",
    variant: textVariant,
  ...
  const buttonMarkup = /* @__PURE__ */ import_react57.default.createElement(UnstyledButton, Object.assign({}, commonProps, linkProps, actionProps), spinnerSVGMarkup, iconMarkup, childMarkup, disclosureMarkup);
  return buttonMarkup;
}
...
var WithinContentContext = /* @__PURE__ */ (0, import_react58.createContext)(false);
...
function ShadowBevel(props) {
  ...
  const Component4 = as;
  return /* @__PURE__ */ import_react59.default.createElement(Component4, {
...
// ../node_modules/@shopify/polaris/build/esm/components/Box/Box.js
var Box = /* @__PURE__ */ (0, import_react60.forwardRef)(({
  as = "div",
  background,
  borderColor,
  borderStyle,
...
var Card = ({
  ...
  return /* @__PURE__ */ import_react61.default.createElement(WithinContentContext.Provider, {
    value: true
  }, /* @__PURE__ */ import_react61.default.createElement(ShadowBevel, {
    boxShadow: "100",
...
function Image({
  ...
  return /* @__PURE__ */ import_react62.default.createElement("img", Object.assign({
    alt,
    src: source,
    crossOrigin,
    className,
...
function Avatar({
  ...
  const i18n = useI18n();
  const isAfterInitialMount = useIsAfterInitialMount();
  const [status, setStatus] = (0, import_react63.useState)(Status.Pending);
  ...
  const imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? /* @__PURE__ */ import_react63.default.createElement(Image, {
  ...
  const avatarPath = /* @__PURE__ */ import_react63.default.createElement(import_react63.default.Fragment, null, /* @__PURE__ */ import_react63.default.createElement("path", {
    fill: "none",
  ...
  const avatarBody = customer || !initials ? avatarPath : /* @__PURE__ */ import_react63.default.createElement("text", {
  ...
  const svgMarkup = hasImage ? null : /* @__PURE__ */ import_react63.default.createElement("span", {
...
var WithinFilterContext = /* @__PURE__ */ (0, import_react64.createContext)(false);
...
function Badge({
  ...
  if (progress && !icon) {
    accessibilityMarkup = /* @__PURE__ */ import_react66.default.createElement("span", {
...
function useEventListener(eventName, handler, target, options) {
  const handlerRef = (0, import_react67.useRef)(handler);
...
var Spinner2 = /* @__PURE__ */ import_react68.default.forwardRef(function Spinner3({
  onChange,
  onClick,
  onMouseDown,
  onMouseUp,
...
function Label({
  ...
  return /* @__PURE__ */ import_react70.default.createElement("div", {
    className
  }, /* @__PURE__ */ import_react70.default.createElement("label", {
    id: labelID(id),
    htmlFor: id,
...
function buttonFrom({
  ...
  return /* @__PURE__ */ import_react71.default.createElement(Button, Object.assign({
    key,
    onClick: onAction,
    tone,
...
function useToggle(initialState) {
  const [value, setState] = (0, import_react73.useState)(initialState);
  return {
    value,
    toggle: (0, import_react73.useCallback)(() => setState((state) => !state), []),
    setTrue: (0, import_react73.useCallback)(() => setState(true), []),
    setFalse: (0, import_react73.useCallback)(() => setState(false), [])
  };
}
...
function Connected({
  ...
  const leftConnectionMarkup = left ? /* @__PURE__ */ import_react75.default.createElement(Item, {
    position: "left"
  }, left) : null;
  const rightConnectionMarkup = right ? /* @__PURE__ */ import_react75.default.createElement(Item, {
    position: "right"
  }, right) : null;
  return /* @__PURE__ */ import_react75.default.createElement("div", {
    className: styles14.Connected
  }, leftConnectionMarkup, /* @__PURE__ */ import_react75.default.createElement(Item, {
    position: "primary"
...
function Resizer({
  ...
  const contentNode = (0, import_react76.useRef)(null);
  const minimumLinesNode = (0, import_react76.useRef)(null);
  const animationFrame = (0, import_react76.useRef)();
  const currentHeight = (0, import_react76.useRef)(currentHeightProp);
  ...
  const minimumLinesMarkup = minimumLines ? /* @__PURE__ */ import_react76.default.createElement("div", {
  ...
  const handleHeightCheck = (0, import_react76.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
  ...
  }, /* @__PURE__ */ import_react76.default.createElement(EventListener, {
    event: "resize",
...
function TextField({
  ...
  const i18n = useI18n();
  const [height2, setHeight] = (0, import_react77.useState)(null);
  const [focus, setFocus] = (0, import_react77.useState)(Boolean(focused));
  const isAfterInitial = useIsAfterInitialMount();
  const uniqId = (0, import_react77.useId)();
  const id = idProp ?? uniqId;
  const textFieldRef = (0, import_react77.useRef)(null);
  const inputRef = (0, import_react77.useRef)(null);
  const textAreaRef = (0, import_react77.useRef)(null);
  const prefixRef = (0, import_react77.useRef)(null);
  const suffixRef = (0, import_react77.useRef)(null);
  const loadingRef = (0, import_react77.useRef)(null);
  const verticalContentRef = (0, import_react77.useRef)(null);
  const buttonPressTimer = (0, import_react77.useRef)();
  const spinnerRef = (0, import_react77.useRef)(null);
  const getInputRef = (0, import_react77.useCallback)(() => {
  ...
  const iconPrefix = /* @__PURE__ */ import_react77.default.isValidElement(prefix) && prefix.type === Icon;
  const prefixMarkup = prefix ? /* @__PURE__ */ import_react77.default.createElement("div", {
  ...
  const suffixMarkup = suffix ? /* @__PURE__ */ import_react77.default.createElement("div", {
  ...
  const loadingMarkup = loading ? /* @__PURE__ */ import_react77.default.createElement("div", {
  ...
  if (showCharacterCount) {
    ...
    characterCountMarkup = /* @__PURE__ */ import_react77.default.createElement("div", {
  ...
  const clearButtonMarkup = clearButton && clearButtonVisible ? /* @__PURE__ */ import_react77.default.createElement("button", {
    type: "button",
    ...
    as: "span",
    visuallyHidden: true
  }, i18n.translate("Polaris.Common.clear")), /* @__PURE__ */ import_react77.default.createElement(Icon, {
    source: SvgXCircleIcon,
    tone: "base"
  })) : null;
  const handleNumberChange = (0, import_react77.useCallback)((steps, stepAmount = normalizedStep) => {
  ...
  const handleSpinnerButtonRelease = (0, import_react77.useCallback)(() => {
    clearTimeout(buttonPressTimer.current);
  }, []);
  const handleSpinnerButtonPress = (0, import_react77.useCallback)((onChange2) => {
  ...
  const spinnerMarkup = isNumericType && step !== 0 && !disabled && !readOnly ? /* @__PURE__ */ import_react77.default.createElement(Spinner2, {
    onClick: handleClickChild,
  ...
  const handleExpandingResize = (0, import_react77.useCallback)((height3) => {
    setHeight(height3);
  }, []);
  const resizer = multiline && isAfterInitial ? /* @__PURE__ */ import_react77.default.createElement(Resizer, {
  ...
  const input = /* @__PURE__ */ (0, import_react77.createElement)(multiline ? "textarea" : "input", {
    name,
    id,
    disabled,
    readOnly,
  ...
  const inputWithVerticalContentMarkup = verticalContent ? /* @__PURE__ */ import_react77.default.createElement("div", {
  ...
  const backdropMarkup = /* @__PURE__ */ import_react77.default.createElement("div", {
  ...
  const inputAndSuffixMarkup = autoSize ? /* @__PURE__ */ import_react77.default.createElement("div", {
  ...
  }, inputMarkup), suffixMarkup) : /* @__PURE__ */ import_react77.default.createElement(import_react77.default.Fragment, null, inputMarkup, suffixMarkup);
  return /* @__PURE__ */ import_react77.default.createElement(Labelled, {
    label,
    id,
    error,
    action: labelAction,
    ...
    disabled,
    readOnly
  }, /* @__PURE__ */ import_react77.default.createElement(Connected, {
    left: connectedLeft,
...
var FilterActionsContext = /* @__PURE__ */ (0, import_react78.createContext)(false);
function FilterActionsProvider({
  children,
  filterActions
}) {
  return /* @__PURE__ */ import_react78.default.createElement(FilterActionsContext.Provider, {
    value: filterActions
  }, children);
}
...
function useEphemeralPresenceManager() {
  const ephemeralPresenceManager = (0, import_react79.useContext)(EphemeralPresenceManagerContext);
...
function usePortalsManager() {
  const portalsManager = (0, import_react80.useContext)(PortalsManagerContext);
  if (!portalsManager) {
...
function ThemeProvider(props) {
  ...
  return /* @__PURE__ */ import_react81.default.createElement(ThemeNameContext.Provider, {
    value: themeName
  }, /* @__PURE__ */ import_react81.default.createElement(ThemeContext.Provider, {
    value: getTheme(themeName)
  }, /* @__PURE__ */ import_react81.default.createElement(ThemeContainer, {
...
function Portal({
  ...
  const uniqueId = (0, import_react82.useId)();
  const portalId = idPrefix !== "" ? `${idPrefix}-${uniqueId}` : uniqueId;
  (0, import_react82.useEffect)(() => {
    onPortalCreated();
  }, [onPortalCreated]);
  return container ? /* @__PURE__ */ (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react82.default.createElement(ThemeProvider, {
...
function useLazyRef(initialValue) {
  const lazyRef = (0, import_react83.useRef)(UNIQUE_IDENTIFIER);
...
function useComponentDidMount(callback) {
  const isAfterInitialMount = useIsAfterInitialMount();
  const hasInvokedLifeCycle = (0, import_react84.useRef)(false);
...
var ScrollableContext = /* @__PURE__ */ (0, import_react85.createContext)(void 0);
...
function ScrollTo() {
  const anchorNode = (0, import_react86.useRef)(null);
  const scrollToPosition = (0, import_react86.useContext)(ScrollableContext);
  ...
  return /* @__PURE__ */ import_react86.default.createElement("a", {
    id,
    ref: anchorNode
  });
}
...
var ScrollableComponent = /* @__PURE__ */ (0, import_react87.forwardRef)(({
  children,
  className,
  horizontal = true,
  vertical = true,
  ...
  const [topShadow, setTopShadow] = (0, import_react87.useState)(false);
  const [bottomShadow, setBottomShadow] = (0, import_react87.useState)(false);
  const stickyManager = useLazyRef(() => new StickyManager());
  const scrollArea = (0, import_react87.useRef)(null);
  const scrollTo = (0, import_react87.useCallback)((scrollY, options = {}) => {
  ...
  const defaultRef = (0, import_react87.useRef)();
  (0, import_react87.useImperativeHandle)(forwardedRef || defaultRef, () => ({
    scrollTo
  }));
  const handleScroll = (0, import_react87.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react87.default.createElement(ScrollableContext.Provider, {
    value: scrollTo
  }, /* @__PURE__ */ import_react87.default.createElement(StickyManagerContext.Provider, {
    value: stickyManager.current
  }, /* @__PURE__ */ import_react87.default.createElement("div", Object.assign({
...
// ../node_modules/@shopify/polaris/build/esm/components/Tooltip/components/TooltipOverlay/TooltipOverlay.js
var tailUpPaths = /* @__PURE__ */ import_react89.default.createElement(import_react89.default.Fragment, null, /* @__PURE__ */ import_react89.default.createElement("path", {
...
var tailDownPaths = /* @__PURE__ */ import_react89.default.createElement(import_react89.default.Fragment, null, /* @__PURE__ */ import_react89.default.createElement("path", {
...
function TooltipOverlay({
  ...
  const i18n = useI18n();
  const markup = active ? /* @__PURE__ */ import_react89.default.createElement(PositionedOverlay, {
    active,
    activator,
    preferredPosition,
    preventInteraction,
  ...
  function renderTooltip(overlayDetails) {
    ...
    }, layer.props), /* @__PURE__ */ import_react89.default.createElement("svg", {
      className: styles18.Tail,
      width: "19",
      height: "11",
      fill: "none"
    }, positioning === "above" ? tailDownPaths : tailUpPaths), /* @__PURE__ */ import_react89.default.createElement("div", {
      id,
      role: "tooltip",
...
function Tooltip({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react90.useState)(null);
  const {
    presenceList,
    addPresence,
    removePresence
  } = useEphemeralPresenceManager();
  const id = (0, import_react90.useId)();
  const activatorContainer = (0, import_react90.useRef)(null);
  const mouseEntered = (0, import_react90.useRef)(false);
  const [shouldAnimate, setShouldAnimate] = (0, import_react90.useState)(Boolean(!originalActive));
  const hoverDelayTimeout = (0, import_react90.useRef)(null);
  const hoverOutTimeout = (0, import_react90.useRef)(null);
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react90.default.createElement(Portal, {
    idPrefix: "tooltip"
  }, /* @__PURE__ */ import_react90.default.createElement(TooltipOverlay, {
    id,
    preferredPosition,
  ...
  return /* @__PURE__ */ import_react90.default.createElement(WrapperComponent, {
    onFocus: () => {
      handleOpen();
      handleFocus();
    },
...
var InlineStack = function InlineStack2({
  ...
  return /* @__PURE__ */ import_react91.default.createElement(Element2, {
...
function Item2({
  ...
  if (prefix) {
    prefixMarkup = /* @__PURE__ */ import_react92.default.createElement("span", {
  ...
  if (truncate && content) {
    contentText = /* @__PURE__ */ import_react92.default.createElement(TruncateText, null, content);
  } else if (ellipsis) {
    contentText = `${content}\u2026`;
  }
  const contentMarkup = helpText ? /* @__PURE__ */ import_react92.default.createElement(import_react92.default.Fragment, null, /* @__PURE__ */ import_react92.default.createElement(Box, null, contentText), /* @__PURE__ */ import_react92.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    tone: active || disabled ? void 0 : "subdued"
  }, helpText)) : /* @__PURE__ */ import_react92.default.createElement(Text, {
    as: "span",
    variant: "bodyMd",
    fontWeight: active ? "semibold" : "regular"
  }, contentText);
  const badgeMarkup = badge && /* @__PURE__ */ import_react92.default.createElement("span", {
    className: styles15.Suffix
  }, /* @__PURE__ */ import_react92.default.createElement(Badge, {
    tone: badge.tone
  }, badge.content));
  const suffixMarkup = suffix && /* @__PURE__ */ import_react92.default.createElement(Box, null, /* @__PURE__ */ import_react92.default.createElement("span", {
    className: styles15.Suffix
  }, suffix));
  const textMarkup = /* @__PURE__ */ import_react92.default.createElement("span", {
  ...
  const contentElement = /* @__PURE__ */ import_react92.default.createElement(InlineStack, {
    blockAlign: "center",
    gap: "150",
    wrap: false
  }, prefixMarkup, textMarkup, badgeMarkup, suffixMarkup);
  const contentWrapper = /* @__PURE__ */ import_react92.default.createElement(Box, {
    width: "100%"
  }, contentElement);
  const scrollMarkup = active ? /* @__PURE__ */ import_react92.default.createElement(Scrollable.ScrollTo, null) : null;
  const control = url ? /* @__PURE__ */ import_react92.default.createElement(UnstyledLink, {
    id,
    ...
    role
  }, contentWrapper) : /* @__PURE__ */ import_react92.default.createElement("button", {
    id,
    type: "button",
    className,
    disabled,
  ...
  return /* @__PURE__ */ import_react92.default.createElement(import_react92.default.Fragment, null, scrollMarkup, control);
}
var TruncateText = ({
  children
}) => {
  const theme = useTheme();
  const textRef = (0, import_react92.useRef)(null);
  const [isOverflowing, setIsOverflowing] = (0, import_react92.useState)(false);
  useIsomorphicLayoutEffect(() => {
    if (textRef.current) {
      setIsOverflowing(textRef.current.scrollWidth > textRef.current.offsetWidth);
    }
  }, [children]);
  const text2 = /* @__PURE__ */ import_react92.default.createElement(Text, {
    as: "span",
    truncate: true
  ...
  return isOverflowing ? /* @__PURE__ */ import_react92.default.createElement(Tooltip, {
...
var BlockStack = ({
  ...
  return /* @__PURE__ */ import_react93.default.createElement(as, {
    className,
    id,
    style: sanitizeCustomProperties(style),
    ...restProps
...
function KeypressListener({
  ...
  const tracked = (0, import_react95.useRef)({
    handler,
    keyCode
  });
  useIsomorphicLayoutEffect(() => {
  ...
  const handleKeyEvent = (0, import_react95.useCallback)((event) => {
    const {
      handler: handler2,
      keyCode: keyCode2
    } = tracked.current;
...
function ActionList({
  ...
  const sectionMarkup = filteredSections.map((section, index) => {
    return section.items.length > 0 ? /* @__PURE__ */ import_react96.default.createElement(Section, {
...
function wrapWithComponent(element, Component4, props) {
  ...
  return isElementOfType(element, Component4) ? element : /* @__PURE__ */ import_react97.default.createElement(Component4, props, element);
}
...
function isElementOfType(element, Component4) {
  if (element == null || !/* @__PURE__ */ (0, import_react97.isValidElement)(element) || typeof element.type === "string") {
    return false;
  }
  const {
    type: defaultType
...
function elementChildren(children, predicate = () => true) {
  return import_react97.Children.toArray(children).filter((child) => /* @__PURE__ */ (0, import_react97.isValidElement)(child) && predicate(child));
}
...
function Pane({
  ...
  return fixed ? /* @__PURE__ */ import_react99.default.createElement("div", {
    style,
    className
  }, content) : /* @__PURE__ */ import_react99.default.createElement(Scrollable, {
    shadow: true,
    className,
    style,
    onScrolledToBottom,
...
var PopoverOverlay = class extends import_react100.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      transitionStatus: this.props.active ? TransitionStatus.Entering : TransitionStatus.Exited
    };
    this.contentNode = /* @__PURE__ */ (0, import_react100.createRef)();
    this.renderPopover = (overlayDetails) => {
      ...
      return /* @__PURE__ */ import_react100.default.createElement("div", Object.assign({
        className
      }, overlay.props), /* @__PURE__ */ import_react100.default.createElement(EventListener, {
        event: "click",
    ...
    this.overlayRef = /* @__PURE__ */ (0, import_react100.createRef)();
  }
  forceUpdatePosition() {
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react100.default.createElement(PositionedOverlay, {
      ref: this.overlayRef,
      fullWidth,
      active,
      activator,
...
// ../node_modules/@shopify/polaris/build/esm/components/Popover/Popover.js
var PopoverComponent = /* @__PURE__ */ (0, import_react101.forwardRef)(function Popover({
  ...
  const [activatorNode, setActivatorNode] = (0, import_react101.useState)();
  const overlayRef = (0, import_react101.useRef)(null);
  const activatorContainer = (0, import_react101.useRef)(null);
  const WrapperComponent = activatorWrapper;
  ...
  const setAccessibilityAttributes = (0, import_react101.useCallback)(() => {
  ...
  const portal2 = activatorNode ? /* @__PURE__ */ import_react101.default.createElement(Portal, {
    idPrefix: "popover"
  }, /* @__PURE__ */ import_react101.default.createElement(PopoverOverlay, Object.assign({
    ref: overlayRef,
    id,
    activator: activatorNode,
    preferInputActivator,
  ...
  return /* @__PURE__ */ import_react101.default.createElement(WrapperComponent, {
    ref: activatorContainer
  }, import_react101.Children.only(activator), portal2);
});
...
function ButtonGroup({
  ...
  const contents = elementChildren(children).map((child, index) => /* @__PURE__ */ import_react103.default.createElement(Item3, {
    button: child,
    key: index
  }));
...
var BannerContext = /* @__PURE__ */ (0, import_react104.createContext)(false);
...
// ../node_modules/@shopify/polaris/build/esm/components/Banner/Banner.js
var Banner = /* @__PURE__ */ (0, import_react106.forwardRef)(function Banner2(props, bannerRef) {
  const {
    tone,
    stopAnnouncements
  } = props;
  const withinContentContainer = (0, import_react106.useContext)(WithinContentContext);
  const {
    wrapperRef,
    handleKeyUp,
    handleBlur,
  ...
  return /* @__PURE__ */ import_react106.default.createElement(BannerContext.Provider, {
    value: true
    ...
    onKeyUp: handleKeyUp,
    onBlur: handleBlur
  }, /* @__PURE__ */ import_react106.default.createElement(BannerLayout, props)));
});
function BannerLayout({
  ...
  const sharedBannerProps = {
    ...
    bannerTitle: title ? /* @__PURE__ */ import_react106.default.createElement(Text, {
      as: "h2",
      variant: "headingSm",
      breakWord: true
    }, title) : null,
    bannerIcon: hideIcon ? null : /* @__PURE__ */ import_react106.default.createElement("span", {
    ...
    actionButtons: action || secondaryAction ? /* @__PURE__ */ import_react106.default.createElement(ButtonGroup, null, action && /* @__PURE__ */ import_react106.default.createElement(Button, Object.assign({
      onClick: action.onAction
    }, action), action.content), secondaryAction && /* @__PURE__ */ import_react106.default.createElement(Button, Object.assign({
      onClick: secondaryAction.onAction
    }, secondaryAction), secondaryAction.content)) : null,
    dismissButton: onDismiss ? /* @__PURE__ */ import_react106.default.createElement(Button, {
      variant: "tertiary",
  ...
  const childrenMarkup = children ? /* @__PURE__ */ import_react106.default.createElement(Text, {
    as: "span",
    variant: "bodyMd"
  }, children) : null;
  if (withinContentContainer) {
    return /* @__PURE__ */ import_react106.default.createElement(WithinContentContainerBanner, sharedBannerProps, childrenMarkup);
  }
  if (isInlineIconBanner) {
    return /* @__PURE__ */ import_react106.default.createElement(InlineIconBanner, sharedBannerProps, childrenMarkup);
  }
  return /* @__PURE__ */ import_react106.default.createElement(DefaultBanner, sharedBannerProps, childrenMarkup);
}
function DefaultBanner({
  ...
  return /* @__PURE__ */ import_react106.default.createElement(Box, {
    width: "100%"
  }, /* @__PURE__ */ import_react106.default.createElement(BlockStack, {
    align: "space-between"
    ...
    gap: "100",
    wrap: false
  }, bannerIcon, bannerTitle), dismissButton)), hasContent && /* @__PURE__ */ import_react106.default.createElement(Box, {
    padding: {
      xs: "300",
      md: "400"
    },
    ...
    gap: "200"
  }, /* @__PURE__ */ import_react106.default.createElement("div", null, children), actionButtons))));
}
function InlineIconBanner({
  ...
  const [blockAlign, setBlockAlign] = (0, import_react106.useState)("center");
  const contentNode = (0, import_react106.useRef)(null);
  const iconNode = (0, import_react106.useRef)(null);
  const dismissIconNode = (0, import_react106.useRef)(null);
  const handleResize = (0, import_react106.useCallback)(() => {
  ...
  (0, import_react106.useEffect)(() => handleResize(), [handleResize]);
  ...
  return /* @__PURE__ */ import_react106.default.createElement(Box, {
    ...
    wrap: false,
    blockAlign
  }, bannerIcon ? /* @__PURE__ */ import_react106.default.createElement("div", {
    ref: iconNode
  }, /* @__PURE__ */ import_react106.default.createElement(Box, {
    background: backgroundColor,
    borderRadius: "200",
    padding: "100"
  }, bannerIcon)) : null, /* @__PURE__ */ import_react106.default.createElement(Box, {
    ref: contentNode,
    width: "100%"
  }, /* @__PURE__ */ import_react106.default.createElement(BlockStack, {
    gap: "200"
  }, /* @__PURE__ */ import_react106.default.createElement("div", null, children), actionButtons)))), /* @__PURE__ */ import_react106.default.createElement("div", {
    ref: dismissIconNode,
...
function WithinContentContainerBanner({
  ...
  return /* @__PURE__ */ import_react106.default.createElement(Box, {
    ...
    gap: "150",
    wrap: false
  }, bannerIcon, /* @__PURE__ */ import_react106.default.createElement(Box, {
    width: "100%"
  }, /* @__PURE__ */ import_react106.default.createElement(BlockStack, {
    gap: "200"
  }, /* @__PURE__ */ import_react106.default.createElement(BlockStack, {
    gap: "050"
  }, bannerTitle, /* @__PURE__ */ import_react106.default.createElement("div", null, children)), actionButtons))), dismissButton));
}
...
function Cell({
  ...
  const iconMarkup = /* @__PURE__ */ import_react107.default.createElement("span", {
  ...
  const sortableHeadingContent = /* @__PURE__ */ import_react107.default.createElement("button", {
  ...
  const stickyHeading = /* @__PURE__ */ import_react107.default.createElement("th", Object.assign({
    ref: setRef
  ...
  const headingMarkup = header ? /* @__PURE__ */ import_react107.default.createElement("th", Object.assign({}, headerCell.props, {
    "aria-sort": sortDirection
  }, colSpanProp, {
    ref: setRef,
    className,
  ...
  }), columnHeadingContent) : /* @__PURE__ */ import_react107.default.createElement("th", Object.assign({}, colSpanProp, {
    ref: setRef,
    className,
    scope: "row",
    style: {
  ...
  }), truncate ? /* @__PURE__ */ import_react107.default.createElement(TruncatedText, {
    className: styles26.TooltipContent
  }, content) : content);
  const cellMarkup = header || firstColumn || nthColumn ? headingMarkup : /* @__PURE__ */ import_react107.default.createElement("td", Object.assign({
    className
  }, colSpanProp), content);
...
var TruncatedText = ({
  ...
  const textRef = (0, import_react107.useRef)(null);
  const {
    current
  } = textRef;
  const text2 = /* @__PURE__ */ import_react107.default.createElement("span", {
    ref: textRef,
    className
  }, children);
  return current?.scrollWidth > current?.offsetWidth ? /* @__PURE__ */ import_react107.default.createElement(Tooltip, {
...
function AfterInitialMount({
  ...
  return /* @__PURE__ */ import_react109.default.createElement(import_react109.default.Fragment, null, content);
}
...
function useStickyManager() {
  const stickyManager = (0, import_react110.useContext)(StickyManagerContext);
  if (!stickyManager) {
...
// ../node_modules/@shopify/polaris/build/esm/components/Sticky/Sticky.js
var StickyInner = class extends import_react111.Component {
  constructor(...args) {
    super(...args);
    this.state = {
      isSticky: false,
  ...
  render() {
    ...
    return /* @__PURE__ */ import_react111.default.createElement("div", null, /* @__PURE__ */ import_react111.default.createElement("div", {
...
function Sticky(props) {
  ...
  return /* @__PURE__ */ import_react111.default.createElement(StickyInner, Object.assign({}, props, {
    stickyManager
  }));
}
...
function Navigation({
  ...
  }), pipMarkup, /* @__PURE__ */ import_react112.default.createElement(Button, {
    variant: "tertiary",
    icon: SvgChevronRightIcon,
...
var DataTableInner = class extends import_react113.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      condensed: false,
    ...
    this.dataTable = /* @__PURE__ */ (0, import_react113.createRef)();
    this.scrollContainer = /* @__PURE__ */ (0, import_react113.createRef)();
    this.table = /* @__PURE__ */ (0, import_react113.createRef)();
    this.stickyTable = /* @__PURE__ */ (0, import_react113.createRef)();
    this.stickyNav = null;
    this.headerNav = null;
    this.tableHeadings = [];
    this.stickyHeadings = [];
    ...
    this.renderHeading = ({
      ...
      if (inFixedNthColumn && inStickyHeader) {
        return [/* @__PURE__ */ import_react113.default.createElement(Cell, Object.assign({
          key: id
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
        ...
        })), /* @__PURE__ */ import_react113.default.createElement(Cell, Object.assign({
          key: `${id}-sticky`
        }, cellProps, {
          setRef: (ref) => {
            this.setCellRef({
    ...
    this.renderTotals = ({
      ...
      return /* @__PURE__ */ import_react113.default.createElement(Cell, {
        total: true,
        totalInFooter,
    ...
    this.defaultRenderRow = ({
      ...
      return /* @__PURE__ */ import_react113.default.createElement("tr", {
        key: `row-${index}`,
        className,
  ...
  render() {
    ...
    const headingMarkup = /* @__PURE__ */ import_react113.default.createElement("tr", null, headings.map((heading, index) => this.renderHeading({
      heading,
      headingIndex: index,
      inFixedNthColumn: false,
      inStickyHeader: false
    })));
    const totalsMarkup = totals ? /* @__PURE__ */ import_react113.default.createElement("tr", null, totals.map((total, index) => this.renderTotals({
      total,
      index
    }))) : null;
    ...
    const fixedNthColumnMarkup = condensed && fixedFirstColumns !== 0 && /* @__PURE__ */ import_react113.default.createElement("table", {
    ...
    }, /* @__PURE__ */ import_react113.default.createElement("thead", null, /* @__PURE__ */ import_react113.default.createElement("tr", {
      style: {
      ...
      inStickyHeader: false
    }))), totals && !showTotalsInFooter && /* @__PURE__ */ import_react113.default.createElement("tr", {
      style: {
      ...
      total,
      index
    })))), /* @__PURE__ */ import_react113.default.createElement("tbody", null, nthColumns.map((row, index) => this.defaultRenderRow({
      row,
      index,
      inFixedNthColumn: true,
      rowHeights: bodyRowHeights
    }))), totals && showTotalsInFooter && /* @__PURE__ */ import_react113.default.createElement("tfoot", null, /* @__PURE__ */ import_react113.default.createElement("tr", null, nthTotals?.map((total, index) => this.renderTotals({
      total,
      index
    })))));
    ...
    const footerMarkup = footerContent ? /* @__PURE__ */ import_react113.default.createElement("div", {
      className: styles26.Footer
    }, footerContent) : null;
    const paginationMarkup = pagination ? /* @__PURE__ */ import_react113.default.createElement(Pagination, Object.assign({
      type: "table"
    }, pagination)) : null;
    const headerTotalsMarkup = !showTotalsInFooter ? totalsMarkup : null;
    const footerTotalsMarkup = showTotalsInFooter ? /* @__PURE__ */ import_react113.default.createElement("tfoot", null, totalsMarkup) : null;
    const navigationMarkup = (location) => hideScrollIndicator ? null : /* @__PURE__ */ import_react113.default.createElement(Navigation, {
      columnVisibilityData,
      isScrolledFarthestLeft,
      isScrolledFarthestRight,
    ...
    const stickyHeaderMarkup = stickyHeader ? /* @__PURE__ */ import_react113.default.createElement(AfterInitialMount, null, /* @__PURE__ */ import_react113.default.createElement("div", {
      className: styles26.StickyHeaderWrapper,
      role: "presentation"
    }, /* @__PURE__ */ import_react113.default.createElement(Sticky, {
      ...
      }, /* @__PURE__ */ import_react113.default.createElement("div", null, navigationMarkup("sticky")), /* @__PURE__ */ import_react113.default.createElement("table", {
    ...
    return /* @__PURE__ */ import_react113.default.createElement("div", {
      ...
      ref: this.dataTable
    }, stickyHeaderMarkup, navigationMarkup("header"), /* @__PURE__ */ import_react113.default.createElement("div", {
      className
    ...
    }), fixedNthColumnMarkup, /* @__PURE__ */ import_react113.default.createElement("table", {
      className: styles26.Table,
      ref: this.table
    }, /* @__PURE__ */ import_react113.default.createElement("thead", null, headingMarkup, headerTotalsMarkup), /* @__PURE__ */ import_react113.default.createElement("tbody", null, bodyMarkup), footerTotalsMarkup)), paginationMarkup, footerMarkup));
  }
  fixedFirstColumns() {
    const {
      hasFixedFirstColumn,
...
function DataTable(props) {
  const i18n = useI18n();
  return /* @__PURE__ */ import_react113.default.createElement(DataTableInner, Object.assign({}, props, {
    i18n
  }));
}
...
function EmptyState({
  ...
  const [imageLoaded, setImageLoaded] = (0, import_react114.useState)(false);
  ...
  const loadedImageMarkup = largeImage ? /* @__PURE__ */ import_react114.default.createElement(Image, {
    alt: "",
    role: "presentation",
    source: largeImage,
    ...
    onLoad: handleLoad
  }) : /* @__PURE__ */ import_react114.default.createElement(Image, {
    alt: "",
    role: "presentation",
    className: imageClassNames,
    source: image,
  ...
  const imageMarkup = /* @__PURE__ */ import_react114.default.createElement("div", {
    className: imageContainerClassNames
  }, loadedImageMarkup, /* @__PURE__ */ import_react114.default.createElement("div", {
    className: skeletonImageClassNames
  }));
  const secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, {}) : null;
  const footerContentMarkup = footerContent ? /* @__PURE__ */ import_react114.default.createElement(Box, {
  ...
  const headingMarkup = heading ? /* @__PURE__ */ import_react114.default.createElement(Box, {
    paddingBlockEnd: "150"
  }, /* @__PURE__ */ import_react114.default.createElement(Text, {
    variant: "headingMd",
    as: "p",
  ...
  const childrenMarkup = children ? /* @__PURE__ */ import_react114.default.createElement(Text, {
    as: "span",
    alignment: "center",
    variant: "bodySm"
  }, children) : null;
  const textContentMarkup = headingMarkup || children ? /* @__PURE__ */ import_react114.default.createElement(Box, {
    paddingBlockEnd: "400"
  }, headingMarkup, childrenMarkup) : null;
  const actionsMarkup = primaryActionMarkup || secondaryActionMarkup ? /* @__PURE__ */ import_react114.default.createElement(InlineStack, {
    align: "center",
    gap: "200"
  }, secondaryActionMarkup, primaryActionMarkup) : null;
  const detailsMarkup = textContentMarkup || actionsMarkup || footerContentMarkup ? /* @__PURE__ */ import_react114.default.createElement(Box, {
    maxWidth: fullWidth ? "100%" : "400px"
  }, /* @__PURE__ */ import_react114.default.createElement(BlockStack, {
    inlineAlign: "center"
...
var TransitionGroupContext_default = import_react115.default.createContext(null);
...
var Transition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      /* @__PURE__ */ import_react116.default.createElement(TransitionGroupContext_default.Provider, {
        value: null
      }, typeof children === "function" ? children(status, childProps) : import_react116.default.cloneElement(import_react116.default.Children.only(children), childProps))
    );
  };
  return Transition2;
...
var CSSTransition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react117.default.createElement(Transition_default, _extends({}, props, {
...
function getChildMapping(children, mapFn) {
  var mapper = function mapper2(child) {
    return mapFn && (0, import_react118.isValidElement)(child) ? mapFn(child) : child;
  };
  var result = /* @__PURE__ */ Object.create(null);
  if (children)
    import_react118.Children.map(children, function(c) {
      return c;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children).forEach(function(key) {
    ...
    if (!(0, import_react118.isValidElement)(child))
      return;
    var hasPrev = key in prevChildMapping;
    var hasNext = key in nextChildMapping;
    var prevChild = prevChildMapping[key];
    var isLeaving = (0, import_react118.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children[key] = (0, import_react118.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0, import_react118.isValidElement)(prevChild)) {
      children[key] = (0, import_react118.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component4 === null) {
      return /* @__PURE__ */ import_react119.default.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children);
    }
    return /* @__PURE__ */ import_react119.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ import_react119.default.createElement(Component4, props, children));
  };
...
function Section3({
  ...
  return /* @__PURE__ */ import_react120.default.createElement("div", {
    className
  }, /* @__PURE__ */ import_react120.default.createElement(Box, Object.assign({
    as: "section",
    padding: flush ? "0" : "400"
  }, titleHidden && {
    paddingInlineEnd: "0"
...
var FrameContext = /* @__PURE__ */ (0, import_react121.createContext)(void 0);
...
function useFocusManager({
  ...
  const focusManager = (0, import_react122.useContext)(FocusManagerContext);
  ...
  const value = (0, import_react122.useMemo)(() => ({
    canSafelyFocus
  }), [canSafelyFocus]);
...
var Focus = /* @__PURE__ */ (0, import_react123.memo)(function Focus2({
  children,
  disabled,
  root
}) {
  ...
  return /* @__PURE__ */ import_react123.default.createElement(import_react123.default.Fragment, null, children);
});
function isRef(ref) {
...
function TrapFocus({
  ...
  const focusTrapWrapper = (0, import_react124.useRef)(null);
  const [disableFocus, setDisableFocus] = (0, import_react124.useState)(true);
  ...
  return /* @__PURE__ */ import_react124.default.createElement(Focus, {
    disabled: disableFocus,
    root: focusTrapWrapper.current
  }, /* @__PURE__ */ import_react124.default.createElement("div", {
    ref: focusTrapWrapper
  }, /* @__PURE__ */ import_react124.default.createElement(EventListener, {
    event: "focusin",
    handler: handleFocusIn
  }), /* @__PURE__ */ import_react124.default.createElement(KeypressListener, {
    keyCode: Key.Tab,
    keyEvent: "keydown",
    handler: handleTab
  }), children));
...
function Dialog({
  ...
  const theme = useTheme();
  const containerNode = (0, import_react125.useRef)(null);
  const frameContext = (0, import_react125.useContext)(FrameContext);
  let toastMessages;
  if (frameContext) {
  ...
  const ariaLiveAnnouncements = /* @__PURE__ */ import_react125.default.createElement("div", {
    "aria-live": "assertive"
  }, toastMessages ? toastMessages.map((toastMessage) => /* @__PURE__ */ import_react125.default.createElement(Text, {
    visuallyHidden: true,
    as: "p",
    key: toastMessage.id
  }, toastMessage.content)) : null);
  return /* @__PURE__ */ import_react125.default.createElement(TransitionChild, Object.assign({}, props, {
    ...
    "data-polaris-overlay": true,
    ref: containerNode
  }, /* @__PURE__ */ import_react125.default.createElement(TrapFocus, null, /* @__PURE__ */ import_react125.default.createElement("div", {
    role: "dialog",
    "aria-modal": true,
...
function FadeUp({
  ...
  return /* @__PURE__ */ import_react125.default.createElement(CSSTransition_default, Object.assign({}, props, {
...
function CloseButton({
  ...
  const i18n = useI18n();
  return /* @__PURE__ */ import_react126.default.createElement(Button, {
    variant: "tertiary",
    pressed,
    icon: SvgXIcon,
    onClick,
...
function Header({
  ...
  if (titleHidden || !children) {
    return /* @__PURE__ */ import_react128.default.createElement(Box, {
      ...
      zIndex: "1"
    }, /* @__PURE__ */ import_react128.default.createElement(CloseButton, {
      onClick: onClose
    }));
  }
  return /* @__PURE__ */ import_react128.default.createElement(Box, {
    ...
    borderColor: "border",
    background: "bg-surface-tertiary"
  }, /* @__PURE__ */ import_react128.default.createElement(InlineGrid, {
    columns: {
      xs: "1fr auto"
    },
    gap: "400"
    ...
    variant: "headingMd",
    breakWord: true
  }, children)), /* @__PURE__ */ import_react128.default.createElement(CloseButton, {
    pressed: closing,
    onClick: onClose
  })));
}
...
function useScrollLockManager() {
  const scrollLockManager = (0, import_react129.useContext)(ScrollLockManagerContext);
...
function Backdrop(props) {
  ...
  return /* @__PURE__ */ import_react131.default.createElement(import_react131.default.Fragment, null, /* @__PURE__ */ import_react131.default.createElement(ScrollLock, null), /* @__PURE__ */ import_react131.default.createElement("div", {
    className,
    onClick: handleClick,
    onTouchStart,
...
function Footer({
  ...
  const actions = primaryActionButton || secondaryActionButtons ? /* @__PURE__ */ import_react132.default.createElement(InlineStack, {
    gap: "200"
  }, secondaryActionButtons, primaryActionButton) : null;
  return /* @__PURE__ */ import_react132.default.createElement(InlineStack, {
    gap: "400",
    blockAlign: "center"
    ...
    blockAlign: "center",
    align: "space-between"
  }, /* @__PURE__ */ import_react132.default.createElement(Box, null, children), actions)));
}
...
var Modal = function Modal2({
  ...
  const [iframeHeight, setIframeHeight] = (0, import_react133.useState)(IFRAME_LOADING_HEIGHT);
  const [closing, setClosing] = (0, import_react133.useState)(false);
  const headerId = (0, import_react133.useId)();
  const activatorRef = (0, import_react133.useRef)(null);
  const i18n = useI18n();
  const iframeTitle = i18n.translate("Polaris.Modal.iFrameTitle");
  let dialog;
  let backdrop;
  const handleEntered = (0, import_react133.useCallback)(() => {
    if (onTransitionEnd) {
      onTransitionEnd();
    }
  }, [onTransitionEnd]);
  const handleExited = (0, import_react133.useCallback)(() => {
  ...
  const handleIFrameLoad = (0, import_react133.useCallback)((evt) => {
  ...
  if (open) {
    const footerMarkup = !footer && !primaryAction && !secondaryActions ? null : /* @__PURE__ */ import_react133.default.createElement(Footer, {
      primaryAction,
      secondaryActions
    }, footer);
    ...
    const body = loading ? /* @__PURE__ */ import_react133.default.createElement(Box, {
      padding: "400"
    }, /* @__PURE__ */ import_react133.default.createElement(InlineStack, {
      gap: "400",
      align: "center",
      blockAlign: "center"
    }, /* @__PURE__ */ import_react133.default.createElement(Spinner, null))) : content;
    const scrollContainerMarkup = noScroll ? /* @__PURE__ */ import_react133.default.createElement("div", {
      className: styles29.NoScrollBody
    }, /* @__PURE__ */ import_react133.default.createElement(Box, {
      width: "100%",
      overflowX: "hidden",
      overflowY: "hidden"
    }, body)) : /* @__PURE__ */ import_react133.default.createElement(Scrollable, {
      shadow: true,
      className: styles29.Body,
      onScrolledToBottom
    }, body);
    const bodyMarkup = src ? /* @__PURE__ */ import_react133.default.createElement("iframe", {
      name: iFrameName,
      title: iframeTitle,
      src,
    ...
    dialog = /* @__PURE__ */ import_react133.default.createElement(Dialog, {
      instant,
      labelledBy: headerId,
      onClose,
      ...
      limitHeight,
      setClosing
    }, /* @__PURE__ */ import_react133.default.createElement(Header, {
      titleHidden,
      id: headerId,
      closing,
      onClose
    }, title), bodyMarkup, footerMarkup);
    backdrop = /* @__PURE__ */ import_react133.default.createElement(Backdrop, {
      setClosing,
      onClick: onClose
    });
  }
  const animated = !instant;
  const activatorMarkup = activator && !isRef2(activator) ? /* @__PURE__ */ import_react133.default.createElement(Box, {
    ref: activatorRef,
    as: activatorWrapper
  }, activator) : null;
  return /* @__PURE__ */ import_react133.default.createElement(WithinContentContext.Provider, {
    value: true
  }, activatorMarkup, /* @__PURE__ */ import_react133.default.createElement(Portal, {
    idPrefix: "modal"
  }, /* @__PURE__ */ import_react133.default.createElement(TransitionGroup_default, {
    appear: animated,
    enter: animated,
    exit: animated
  }, dialog), backdrop));
...
function AnnotatedSection({
  ...
  const descriptionMarkup = typeof description === "string" ? /* @__PURE__ */ import_react135.default.createElement(Text, {
    as: "p",
    variant: "bodyMd"
  ...
  }, /* @__PURE__ */ import_react135.default.createElement(TextContainer, {
    spacing: "tight"
  }, /* @__PURE__ */ import_react135.default.createElement(Text, {
    id,
    variant: "headingMd",
    as: "h2"
  }, title), descriptionMarkup && /* @__PURE__ */ import_react135.default.createElement(Box, {
    color: "text-secondary"
  }, descriptionMarkup))), /* @__PURE__ */ import_react135.default.createElement("div", {
...
var Layout = function Layout2({
  ...
  const content = sectioned ? /* @__PURE__ */ import_react137.default.createElement(Section4, null, children) : children;
...
var BulkActions = /* @__PURE__ */ (0, import_react166.forwardRef)(function BulkActions2({
  ...
  const mergedHiddenPromotedActions = hiddenPromotedActionObjects.reduce((memo9, action) => {
    if (!action)
      return memo9;
    if (instanceOfMenuGroupDescriptor(action)) {
      return memo9.concat(action.actions);
    }
    return memo9.concat(action);
  }, []);
  ...
  const allHiddenActions = (0, import_react166.useMemo)(() => {
    ...
    return actions.filter((action) => action).reduce((memo9, action) => {
      ...
      if (isAFlatArray) {
        ...
        const lastItem = memo9[memo9.length - 1];
        memo9.splice(memo9.length - 1, 1, {
...
function useFrame() {
  const frame = (0, import_react168.useContext)(FrameContext);
  if (!frame) {
...
function Form({
  ...
  const submitMarkup = implicitSubmit ? /* @__PURE__ */ import_react169.default.createElement(Text, {
    as: "span",
    visuallyHidden: true
  ...
  return /* @__PURE__ */ import_react169.default.createElement("form", {
    acceptCharset,
    action,
...
function Item5({
  ...
  const className = classNames(styles54.Item, condensed ? styles54.condensed : styles54.grouped);
  return children ? /* @__PURE__ */ import_react170.default.createElement("div", {
    className
  }, children) : null;
}
...
function Group({
  ...
  if (helpText) {
    ...
    helpTextElement = /* @__PURE__ */ import_react171.default.createElement(Box, {
      id: helpTextId,
      color: "text-secondary"
    }, helpText);
  }
  if (title) {
    titleId = `${id}Title`;
    titleElement = /* @__PURE__ */ import_react171.default.createElement(Text, {
      id: titleId,
      as: "p"
    }, title);
  }
  ...
  }, titleElement, /* @__PURE__ */ import_react171.default.createElement(InlineStack, {
    gap: "300"
  }, itemsMarkup), helpTextElement);
}

// ../node_modules/@shopify/polaris/build/esm/components/FormLayout/FormLayout.js
var FormLayout = /* @__PURE__ */ (0, import_react172.memo)(function FormLayout2({
  children
}) {
  return /* @__PURE__ */ import_react172.default.createElement(BlockStack, {
    gap: "400"
...
function Loading() {
  ...
  const [progress, setProgress] = (0, import_react174.useState)(0);
  const [animating, setAnimating] = (0, import_react174.useState)(false);
...
function CSSAnimation({
  ...
  const [transitionStatus, setTransitionStatus] = (0, import_react175.useState)(inProp ? TransitionStatus2.Entering : TransitionStatus2.Exited);
  const isMounted = (0, import_react175.useRef)(false);
  const node = (0, import_react175.useRef)(null);
  ...
  const wrapperClassName = classNames(className, styles57[variationName("start", type)], inProp && styles57[variationName("end", type)]);
...
function DiscardConfirmationModal({
  ...
  const i18n = useI18n();
  return /* @__PURE__ */ import_react176.default.createElement(Modal, {
...
function ContextualSaveBar({
  ...
  const handleDiscardAction = (0, import_react177.useCallback)(() => {
  ...
  const discardConfirmationModalMarkup = discardAction && discardAction.onAction && discardAction.discardConfirmationModal && /* @__PURE__ */ import_react177.default.createElement(DiscardConfirmationModal, {
    open: discardConfirmationModalVisible,
    onCancel: toggleDiscardConfirmationModal,
    onDiscard: handleDiscardAction
  });
  const discardActionMarkup = discardAction && /* @__PURE__ */ import_react177.default.createElement(Button, {
    variant: "tertiary",
    size: "large",
  ...
  const saveActionMarkup = saveAction && /* @__PURE__ */ import_react177.default.createElement(Button, {
    variant: "primary",
    tone: "success",
    size: "large",
    url: saveAction.url,
  ...
  const imageMarkup = logo && /* @__PURE__ */ import_react177.default.createElement(Image, {
    style: {
      width: width2
    },
  ...
  const logoMarkup = alignContentFlush || contextControl ? null : /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles58.LogoContainer,
    style: {
      width: width2
    }
  }, imageMarkup);
  const contextControlMarkup = contextControl ? /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles58.ContextControl
  }, contextControl) : null;
  const contentsClassName = classNames(styles58.Contents, fullWidth && styles58.fullWidth);
  return /* @__PURE__ */ import_react177.default.createElement(import_react177.default.Fragment, null, /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles58.ContextualSaveBar
  }, contextControlMarkup, logoMarkup, /* @__PURE__ */ import_react177.default.createElement("div", {
    className: contentsClassName
  }, /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles58.MessageContainer
  }, /* @__PURE__ */ import_react177.default.createElement(Icon, {
    source: SvgAlertTriangleIcon
  }), message && /* @__PURE__ */ import_react177.default.createElement(Text, {
    as: "h2",
    variant: "headingMd",
    tone: "text-inverse",
    truncate: true
  }, message)), /* @__PURE__ */ import_react177.default.createElement("div", {
    className: styles58.ActionContainer
  }, /* @__PURE__ */ import_react177.default.createElement(LegacyStack, {
    spacing: "tight",
    wrap: false
...
function useDeepCompareRef(dependencies, comparator = import_react_fast_compare3.default) {
  const dependencyList = (0, import_react178.useRef)(dependencies);
...
function useDeepEffect(callback, dependencies, customCompare) {
  (0, import_react179.useEffect)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function useDeepCallback(callback, dependencies, customCompare) {
  return (0, import_react180.useCallback)(callback, useDeepCompareRef(dependencies, customCompare));
}
...
function Toast({
  ...
  const durationRemaining = (0, import_react181.useRef)(defaultDuration);
  const timeoutStart = (0, import_react181.useRef)(null);
  const timer = (0, import_react181.useRef)(null);
  ...
  const dismissMarkup = /* @__PURE__ */ import_react181.default.createElement("button", {
    type: "button",
    className: styles60.CloseButton,
    onClick: onDismiss
  }, /* @__PURE__ */ import_react181.default.createElement(Icon, {
    source: SvgXSmallIcon,
    tone: "inherit"
  }));
  const actionMarkup = action ? /* @__PURE__ */ import_react181.default.createElement("div", {
    className: styles60.Action
  }, /* @__PURE__ */ import_react181.default.createElement(Button, {
  ...
  if (error) {
    leadingIconMarkup = /* @__PURE__ */ import_react181.default.createElement("div", {
      className: styles60.LeadingIcon
    }, /* @__PURE__ */ import_react181.default.createElement(Icon, {
      source: SvgAlertCircleIcon,
      tone: "inherit"
    }));
  ...
  const className = classNames(styles60.Toast, error && styles60.error, tone && styles60[variationName("tone", tone)]);
  if (!action && onClick) {
    return /* @__PURE__ */ import_react181.default.createElement("button", {
      "aria-live": "assertive",
      className: classNames(className, styles60.WithActionOnComponent),
      type: "button",
      onClick
    }, /* @__PURE__ */ import_react181.default.createElement(KeypressListener, {
      keyCode: Key.Escape,
      handler: onDismiss
    }), leadingIconMarkup, /* @__PURE__ */ import_react181.default.createElement(InlineStack, {
      gap: "400",
      blockAlign: "center"
    }, /* @__PURE__ */ import_react181.default.createElement(Text, Object.assign({
      as: "span",
      variant: "bodyMd",
      fontWeight: "medium"
    }, tone === "magic" && {
...
var ToastManager = /* @__PURE__ */ (0, import_react182.memo)(function ToastManager2({
  toastMessages
}) {
  const toastNodes = [];
  const [shouldExpand, setShouldExpand] = (0, import_react182.useState)(false);
  const isFullyExpanded = (0, import_react182.useRef)(false);
  const fullyExpandedTimeout = (0, import_react182.useRef)(null);
  const firstToast = (0, import_react182.useRef)(null);
  ...
  const toastsMarkup = toastMessages.map((toast, index) => {
    ...
    const toastNode = /* @__PURE__ */ (0, import_react182.createRef)();
    ...
    return /* @__PURE__ */ import_react182.default.createElement(CSSTransition_default, {
    ...
    }, /* @__PURE__ */ import_react182.default.createElement(Toast, Object.assign({}, toast, {
      isHovered: shouldExpand
    })))));
  });
  return /* @__PURE__ */ import_react182.default.createElement(Portal, {
    idPrefix: "toast"
  }, /* @__PURE__ */ import_react182.default.createElement(EventListener, {
    event: "resize",
    handler: updateToasts
  }), /* @__PURE__ */ import_react182.default.createElement("div", {
    className: styles59.ToastManager,
    "aria-live": "assertive",
  ...
  }, /* @__PURE__ */ import_react182.default.createElement(TransitionGroup_default, {
    component: null
  }, toastsMarkup)));
});
var toastClasses = {
  enter: classNames(styles59.ToastWrapper, styles59["ToastWrapper-enter"]),
  enterDone: classNames(styles59.ToastWrapper, styles59["ToastWrapper-enter-done"]),
  exit: classNames(styles59.ToastWrapper, styles59["ToastWrapper-exit"])
};
...
var FrameInner = class extends import_react183.PureComponent {
  constructor(...args) {
    super(...args);
    this.state = {
      skipFocused: false,
    ...
    this.navigationNode = /* @__PURE__ */ (0, import_react183.createRef)();
  ...
  render() {
    ...
    const navClassName = classNames(styles55.Navigation, showMobileNavigation && styles55["Navigation-visible"]);
    ...
    const navigationMarkup = navigation ? /* @__PURE__ */ import_react183.default.createElement(UseTheme, null, (theme) => /* @__PURE__ */ import_react183.default.createElement(TrapFocus, {
      trapping: mobileNavShowing
    }, /* @__PURE__ */ import_react183.default.createElement(CSSTransition_default, {
    ...
    }, /* @__PURE__ */ import_react183.default.createElement("div", Object.assign({
      key: "NavContent"
    }, mobileNavAttributes, {
    ...
    }), navigation, /* @__PURE__ */ import_react183.default.createElement("button", {
      type: "button",
      className: styles55.NavigationDismiss,
      ...
      tabIndex
    }, /* @__PURE__ */ import_react183.default.createElement(Icon, {
      source: SvgXIcon
    })))))) : null;
    const loadingMarkup = loadingStack > 0 ? /* @__PURE__ */ import_react183.default.createElement("div", {
      className: styles55.LoadingBar,
      id: APP_FRAME_LOADING_BAR
    }, /* @__PURE__ */ import_react183.default.createElement(Loading, null)) : null;
    const topBarMarkup = topBar ? /* @__PURE__ */ import_react183.default.createElement("div", Object.assign({
      className: styles55.TopBar
    }, layer.props, dataPolarisTopBar.props, {
      id: APP_FRAME_TOP_BAR
    }), topBar) : null;
    const globalRibbonMarkup = globalRibbon ? /* @__PURE__ */ import_react183.default.createElement("div", {
      className: styles55.GlobalRibbonContainer,
      ref: this.setGlobalRibbonContainer
    }, globalRibbon) : null;
    const skipClassName = classNames(styles55.Skip, skipFocused && styles55.focused);
    const skipTarget = skipToContentTarget?.current ? skipToContentTarget.current.id : APP_FRAME_MAIN;
    const skipMarkup = /* @__PURE__ */ import_react183.default.createElement("div", {
      className: skipClassName
    }, /* @__PURE__ */ import_react183.default.createElement("a", {
      href: `#${skipTarget}`,
      onFocus: this.handleFocus,
      onBlur: this.handleBlur,
      onClick: this.handleClick
    ...
    const frameClassName = classNames(styles55.Frame, navigation && styles55.hasNav, topBar && styles55.hasTopBar, sidebar && styles55.hasSidebar);
    const contextualSaveBarMarkup = /* @__PURE__ */ import_react183.default.createElement(CSSAnimation, {
      in: showContextualSaveBar,
      className: styles55.ContextualSaveBar,
      type: "fade"
    }, /* @__PURE__ */ import_react183.default.createElement(ContextualSaveBar, this.contextualSaveBar));
    const navigationOverlayMarkup = showMobileNavigation && isNavigationCollapsed ? /* @__PURE__ */ import_react183.default.createElement(Backdrop, {
    ...
    return /* @__PURE__ */ import_react183.default.createElement(FrameContext.Provider, {
      value: context
    }, /* @__PURE__ */ import_react183.default.createElement("div", Object.assign({
      className: frameClassName
    }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, navigationMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, /* @__PURE__ */ import_react183.default.createElement("main", {
      className: styles55.Main,
      id: APP_FRAME_MAIN,
      "data-has-global-ribbon": Boolean(globalRibbon)
    }, /* @__PURE__ */ import_react183.default.createElement("div", {
      className: styles55.Content
    }, children)), /* @__PURE__ */ import_react183.default.createElement(ToastManager, {
      toastMessages
    }), globalRibbonMarkup, /* @__PURE__ */ import_react183.default.createElement(EventListener, {
      event: "resize",
      handler: this.handleResize
    })));
  }
...
var navTransitionClasses = {
  enter: classNames(styles55["Navigation-enter"]),
  enterActive: classNames(styles55["Navigation-enterActive"]),
  enterDone: classNames(styles55["Navigation-enterActive"]),
  exit: classNames(styles55["Navigation-exit"]),
  exitActive: classNames(styles55["Navigation-exitActive"])
};
function Frame(props) {
  const i18n = useI18n();
  const mediaQuery = useMediaQuery();
  return /* @__PURE__ */ import_react183.default.createElement(FrameInner, Object.assign({}, props, {
    i18n,
    mediaQuery
  }));
}
...
function useIsTouchDevice() {
  const [isTouchDevice, setIsTouchDevice] = (0, import_react184.useState)(false);
  const handleTouchStart = (0, import_react184.useCallback)(() => setIsTouchDevice(true), []);
...
function usePrevious(value) {
  const ref = (0, import_react185.useRef)();
...
function DuplicateModal({
  ...
  const i18n = useI18n();
  const [value, setValue] = (0, import_react186.useState)(name);
  const container = (0, import_react186.useRef)(null);
  ...
  const handleChange = (0, import_react186.useCallback)((newValue) => {
    setValue(newValue);
  }, []);
  ...
  return /* @__PURE__ */ import_react186.default.createElement(Modal, {
    open,
    onClose,
    ...
    instant: true
  }, /* @__PURE__ */ import_react186.default.createElement(Modal.Section, null, /* @__PURE__ */ import_react186.default.createElement(Form, {
    onSubmit: handlePrimaryAction
  }, /* @__PURE__ */ import_react186.default.createElement(FormLayout, null, /* @__PURE__ */ import_react186.default.createElement("div", {
    ref: container
  }, /* @__PURE__ */ import_react186.default.createElement(TextField, {
...
function RenameModal({
  ...
  const i18n = useI18n();
  const [value, setValue] = (0, import_react187.useState)(name);
  const container = (0, import_react187.useRef)(null);
  ...
  const handleChange = (0, import_react187.useCallback)((newValue) => {
    setValue(newValue);
  }, []);
  async function handlePrimaryAction() {
    if (isPrimaryActionDisabled) {
  ...
  return /* @__PURE__ */ import_react187.default.createElement(Modal, {
    open,
    onClose,
    ...
    instant: true
  }, /* @__PURE__ */ import_react187.default.createElement(Modal.Section, null, /* @__PURE__ */ import_react187.default.createElement(Form, {
    onSubmit: handlePrimaryAction
  }, /* @__PURE__ */ import_react187.default.createElement(FormLayout, null, /* @__PURE__ */ import_react187.default.createElement("div", {
    ref: container
  }, /* @__PURE__ */ import_react187.default.createElement(TextField, {
...
// ../node_modules/@shopify/polaris/build/esm/components/Tabs/components/Tab/Tab.js
var Tab = /* @__PURE__ */ (0, import_react188.forwardRef)(({
  content,
  accessibilityLabel,
  badge,
  id,
  ...
  const i18n = useI18n();
  const [popoverActive, setPopoverActive] = (0, import_react188.useState)(false);
  const [activeModalType, setActiveModalType] = (0, import_react188.useState)(null);
  const wasSelected = (0, import_react188.useRef)(selected);
  const panelFocused = (0, import_react188.useRef)(false);
  const node = (0, import_react188.useRef)(null);
  ...
  const togglePopoverActive = (0, import_react188.useCallback)(() => {
    if (!actions?.length) {
      return;
    }
    setPopoverActive((popoverActive2) => !popoverActive2);
  ...
  const handleSaveRenameModal = (0, import_react188.useCallback)(async (value) => {
  ...
  const handleConfirmDeleteView = (0, import_react188.useCallback)(async () => {
    await deleteAction?.onPrimaryAction?.(content);
    handleModalClose();
  }, [deleteAction, content]);
  const handleSaveDuplicateModal = (0, import_react188.useCallback)(async (duplicateName) => {
  ...
  const handleKeyDown2 = (0, import_react188.useCallback)((event) => {
    if (event.key === " ") {
      event.preventDefault();
      handleClick();
    }
  }, [handleClick]);
  const tabContainerClassNames = classNames(styles61.TabContainer, selected && styles61.Underline);
  ...
  const tabClassName = classNames(styles61.Tab, icon && styles61["Tab-iconOnly"], popoverActive && styles61["Tab-popoverActive"], selected && styles61["Tab-active"], selected && actions?.length && styles61["Tab-hasActions"]);
  const badgeMarkup = badge ? /* @__PURE__ */ import_react188.default.createElement(Badge, {
    tone: selected ? void 0 : "new"
  }, badge) : null;
  const disclosureMarkup = selected && actions?.length ? /* @__PURE__ */ import_react188.default.createElement("div", {
    className: classNames(styles61.IconWrap)
  }, /* @__PURE__ */ import_react188.default.createElement(Icon, {
    source: SvgChevronDownIcon
  })) : null;
  const activator = /* @__PURE__ */ import_react188.default.createElement(BaseComponent, {
    id,
    ...
    onClick: handleClick,
    onKeyDown: handleKeyDown2
  }, /* @__PURE__ */ import_react188.default.createElement(InlineStack, {
    gap: "200",
    align: "center",
    blockAlign: "center",
    wrap: false
  }, /* @__PURE__ */ import_react188.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    fontWeight: "medium"
  }, icon ?? content), badgeMarkup), disclosureMarkup);
  const isPlainButton = !selected || !actions?.length;
  const renameModal = renameAction ? /* @__PURE__ */ import_react188.default.createElement(RenameModal, {
    name: content,
  ...
  const duplicateModal = duplicateAction ? /* @__PURE__ */ import_react188.default.createElement(DuplicateModal, {
  ...
  const deleteModal = deleteAction ? /* @__PURE__ */ import_react188.default.createElement(Modal, {
    ...
    instant: true
  }, /* @__PURE__ */ import_react188.default.createElement(Modal.Section, null, i18n.translate("Polaris.Tabs.Tab.deleteModal.description", {
    viewName: content
  }))) : null;
  const markup = isPlainButton || disabled ? activator : /* @__PURE__ */ import_react188.default.createElement(import_react188.default.Fragment, null, /* @__PURE__ */ import_react188.default.createElement(Popover2, {
    active: popoverActive,
    activator,
    autofocusTarget: "first-node",
    onClose: togglePopoverActive
  }, /* @__PURE__ */ import_react188.default.createElement("div", {
    className: styles61.ActionListWrap
  }, /* @__PURE__ */ import_react188.default.createElement(ActionList, {
    actionRole: "menuitem",
  ...
  return /* @__PURE__ */ import_react188.default.createElement("li", {
...
var TabMeasurer = /* @__PURE__ */ (0, import_react189.memo)(function TabMeasurer2({
  selected,
  tabs,
  activator,
  tabToFocus,
  ...
  const containerNode = (0, import_react189.useRef)(null);
  const animationFrame = (0, import_react189.useRef)(null);
  const handleMeasurement = (0, import_react189.useCallback)(() => {
    if (animationFrame.current) {
      cancelAnimationFrame(animationFrame.current);
    }
    animationFrame.current = requestAnimationFrame(() => {
  ...
  const tabsMarkup = tabs.map((tab, index) => {
    return /* @__PURE__ */ import_react189.default.createElement(Tab, {
      measuring: true,
      key: `$${tab.id}Hidden`,
      id: `${tab.id}Measurer`,
      siblingTabHasFocus,
      ...
      url: tab.url,
      content: tab.content,
      onTogglePopover: noop8,
      onToggleModal: noop8
    });
  });
  const classname = classNames(styles61.Tabs, styles61.TabsMeasurer);
  useEventListener("resize", handleMeasurement);
  return /* @__PURE__ */ import_react189.default.createElement("div", {
    className: classname,
    ref: containerNode
...
function Panel({
  ...
  const className = classNames(styles61.Panel, hidden && styles61["Panel-hidden"]);
...
var Item6 = /* @__PURE__ */ (0, import_react191.memo)(function Item7({
  id,
  focused,
  children,
  url,
  ...
  const markup = url ? /* @__PURE__ */ import_react191.default.createElement(UnstyledLink, Object.assign({}, sharedProps, {
    url
  }), children) : /* @__PURE__ */ import_react191.default.createElement("button", Object.assign({}, sharedProps, {
    ref: focusedNode,
    type: "button"
  }), children);
  return /* @__PURE__ */ import_react191.default.createElement("li", null, markup);
});
function noop9() {
}
...
function List({
  ...
  const tabs = disclosureTabs.map(({
    ...
    return /* @__PURE__ */ import_react192.default.createElement(Item6, Object.assign({
      key: id
    }, tabProps, {
      id,
  ...
  return /* @__PURE__ */ import_react192.default.createElement("ul", {
    className: styles61.List,
...
function CreateViewModal({
  ...
  const i18n = useI18n();
  const [value, setValue] = (0, import_react193.useState)("");
  const [loading, setLoading] = (0, import_react193.useState)(false);
  const container = (0, import_react193.useRef)(null);
  ...
  const handleChange = (0, import_react193.useCallback)((newValue) => {
    setValue(newValue);
  }, []);
  async function handlePrimaryAction() {
  ...
  return /* @__PURE__ */ import_react193.default.createElement(Modal, {
    activator,
    open,
    onClose,
  ...
  }, /* @__PURE__ */ import_react193.default.createElement(Modal.Section, null, /* @__PURE__ */ import_react193.default.createElement(Form, {
    onSubmit: handlePrimaryAction
  }, /* @__PURE__ */ import_react193.default.createElement(FormLayout, null, /* @__PURE__ */ import_react193.default.createElement("div", {
    ref: container
  }, /* @__PURE__ */ import_react193.default.createElement(TextField, {
...
var Tabs = ({
  ...
  const scrollRef = (0, import_react194.useRef)(null);
  const wrapRef = (0, import_react194.useRef)(null);
  const selectedTabRef = (0, import_react194.useRef)(null);
  const [state, setState] = (0, import_react194.useReducer)((data, partialData) => {
    return {
      ...data,
      ...partialData
    };
  ...
  const handleTogglePopover = (0, import_react194.useCallback)((isOpen) => setState({
    isTabPopoverOpen: isOpen
  }), []);
  const handleToggleModal = (0, import_react194.useCallback)((isOpen) => setState({
  ...
  const handleTabClick = (0, import_react194.useCallback)((id) => {
  ...
  const renderTabMarkup = (0, import_react194.useCallback)((tab, index) => {
    const handleClick = () => {
    ...
    return /* @__PURE__ */ import_react194.default.createElement(Tab, Object.assign({}, tab, {
      key: `${index}-${tab.id}`,
      id: tab.id,
  ...
  const handleFocus = (0, import_react194.useCallback)((event) => {
    const target = event.target;
    const isItem = target.classList.contains(styles61.Item);
    const isInNaturalDOMOrder = target.closest(`[data-tabs-focus-catchment]`) || isItem;
    const isDisclosureActivator = target.classList.contains(styles61.DisclosureActivator);
  ...
  const handleBlur = (0, import_react194.useCallback)((event) => {
    const target = event.target;
    const relatedTarget = event.relatedTarget;
    const isInNaturalDOMOrder = relatedTarget?.closest?.(`.${styles61.Tabs}`);
    const targetIsATab = target?.classList?.contains?.(styles61.Tab);
    const focusReceiverIsAnItem = relatedTarget?.classList.contains(styles61.Item);
  ...
  const moveToSelectedTab = (0, import_react194.useCallback)(() => {
    const activeButton = selectedTabRef.current?.querySelector(`.${styles61["Tab-active"]}`);
    if (activeButton) {
  ...
  const handleMeasurement = (0, import_react194.useCallback)((measurements) => {
    const {
  ...
  const classname = classNames(styles61.Tabs, fitted && styles61.fitted, disclosureActivatorVisible && styles61.fillSpace);
  const wrapperClassNames = classNames(styles61.Wrapper, canCreateNewView && styles61.WrapperWithNewButton);
  const disclosureTabClassName = classNames(styles61.DisclosureTab, disclosureActivatorVisible && styles61["DisclosureTab-visible"]);
  const disclosureButtonClassName = classNames(styles61.DisclosureActivator);
  const disclosureButtonContent = /* @__PURE__ */ import_react194.default.createElement(import_react194.default.Fragment, null, /* @__PURE__ */ import_react194.default.createElement(Text, {
    as: "span",
    variant: "bodySm",
    fontWeight: "medium"
  }, disclosureText ?? i18n.translate("Polaris.Tabs.toggleTabsLabel")), /* @__PURE__ */ import_react194.default.createElement("div", {
    className: classNames(styles61.IconWrap, disclosureActivatorVisible && showDisclosure && styles61["IconWrap-open"])
  }, /* @__PURE__ */ import_react194.default.createElement(Icon, {
    source: SvgChevronDownIcon,
    tone: "subdued"
  })));
  const disclosureButton = /* @__PURE__ */ import_react194.default.createElement(UnstyledButton, {
    type: "button",
  ...
  const tabMeasurer = /* @__PURE__ */ import_react194.default.createElement(TabMeasurer, {
    tabToFocus,
    activator,
    selected,
    tabs,
  ...
  const newTab = /* @__PURE__ */ import_react194.default.createElement(Tab, {
    ...
    icon: /* @__PURE__ */ import_react194.default.createElement(Icon, {
      source: SvgPlusIcon,
  ...
  const panelMarkup = children ? tabs.map((_tab, index) => {
    return selected === index ? /* @__PURE__ */ import_react194.default.createElement(Panel, {
      id: tabs[index].panelID || `${tabs[index].id}-panel`,
      tabID: tabs[index].id,
      key: tabs[index].id
    }, children) : /* @__PURE__ */ import_react194.default.createElement(Panel, {
      id: tabs[index].panelID || `${tabs[index].id}-panel`,
      tabID: tabs[index].id,
      key: tabs[index].id,
      hidden: true
  ...
  return /* @__PURE__ */ import_react194.default.createElement("div", {
    className: styles61.Outer
  }, /* @__PURE__ */ import_react194.default.createElement(Box, {
    padding: {
      md: "200"
    }
  }, tabMeasurer, /* @__PURE__ */ import_react194.default.createElement("div", {
    className: wrapperClassNames,
    ref: scrollRef
  }, /* @__PURE__ */ import_react194.default.createElement("div", {
    className: styles61.ButtonWrapper,
    ref: wrapRef
  }, /* @__PURE__ */ import_react194.default.createElement("ul", {
  ...
  }, tabsMarkup, mdDown || tabsToShow.length === 0 ? null : /* @__PURE__ */ import_react194.default.createElement("li", {
    className: disclosureTabClassName,
    role: "presentation"
  }, /* @__PURE__ */ import_react194.default.createElement(Popover2, {
    preferredPosition: "below",
    preferredAlignment: "left",
    activator,
    ...
    onClose: handleClose,
    autofocusTarget: "first-node"
  }, /* @__PURE__ */ import_react194.default.createElement(List, {
    focusIndex: hiddenTabs.indexOf(tabToFocus),
    disclosureTabs,
    onClick: handleListTabClick,
    onKeyPress: handleKeyPress
  })))), canCreateNewView && tabsToShow.length > 0 ? /* @__PURE__ */ import_react194.default.createElement("div", {
    className: styles61.NewTab
  }, /* @__PURE__ */ import_react194.default.createElement(CreateViewModal, {
    open: isNewViewModalActive,
    onClose: handleCloseNewViewModal,
    onClickPrimaryAction: handleSaveNewViewModal,
    viewNames,
    activator: disabled ? newTab : /* @__PURE__ */ import_react194.default.createElement("div", null, /* @__PURE__ */ import_react194.default.createElement(Tooltip, {
...
var Toast2 = /* @__PURE__ */ (0, import_react195.memo)(function Toast3(props) {
...
//# sourceMappingURL=/assets/_shared/chunk-OOADYVQX.js.map
