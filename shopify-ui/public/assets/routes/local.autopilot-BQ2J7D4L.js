...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1758759115883.7622";
}
  ...
  function generateDynamicScript() {
    ...
    fetch("/api/generate-script", {
      ...
      body: JSON.stringify({
        ...
        cpc,
        url,
        tier: tenantInfo?.tier || "enterprise"
        // Use tier from loader
      })
...
//# sourceMappingURL=/assets/routes/local.autopilot-BQ2J7D4L.js.map
