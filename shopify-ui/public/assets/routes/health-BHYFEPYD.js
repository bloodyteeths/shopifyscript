...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/health.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1755791240386.1348";
}
function Health() {
...
//# sourceMappingURL=/assets/routes/health-BHYFEPYD.js.map
