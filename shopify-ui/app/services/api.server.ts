...
export class ApiService {
  ...
  async getDashboardMetrics(
    ...
    try {
      const { status, json } = await backendFetch(
        `/dashboard/metrics?range=${dateRange}`,
        "GET",
      );
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch dashboard metrics",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while fetching dashboard metrics",
      };
    }
  }
  ...
  async getInsights(limit: number = 50): Promise<ApiResponse<any[]>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch insights",
      };
    } catch (error) {
  ...
  async getCampaigns(): Promise<ApiResponse<Campaign[]>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch campaigns",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while fetching campaigns",
      };
    }
  }
  ...
  async createCampaign(
    ...
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to create campaign",
      };
    } catch (error) {
  ...
  async updateCampaign(
    ...
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to update campaign",
      };
    } catch (error) {
  ...
  async pauseCampaign(id: string): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to pause campaign",
      };
    } catch (error) {
  ...
  async getAudiences(): Promise<ApiResponse<Audience[]>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch audiences",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while fetching audiences",
      };
    }
  }
  ...
  async createAudience(
    ...
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to create audience",
      };
    } catch (error) {
  ...
  async updateAudience(
    ...
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to update audience",
      };
    } catch (error) {
  ...
  async deleteAudience(id: string): Promise<ApiResponse<void>> {
    try {
      const { status, json } = await backendFetch(`/audiences/${id}`, "POST", {
        _method: "DELETE",
      });
      ...
      return {
        success: false,
        error: json.error || "Failed to delete audience",
      };
    } catch (error) {
  ...
  async getConfig(): Promise<ApiResponse<AppConfig>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch configuration",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while fetching configuration",
      };
    }
  }
  ...
  async updateConfig(
    ...
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to update configuration",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while updating configuration",
      };
    }
  }
  ...
  async getAutopilotStatus(): Promise<ApiResponse<any>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch autopilot status",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while fetching autopilot status",
      };
    }
  }
  ...
  async triggerAutopilot(): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        error: "Network error while triggering autopilot",
      };
    }
  }
  ...
  async getDiagnostics(): Promise<ApiResponse<any>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch diagnostics",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while fetching diagnostics",
      };
    }
  }
  ...
  async getRunLogs(limit: number = 100): Promise<ApiResponse<any[]>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to fetch run logs",
      };
    } catch (error) {
  ...
  async testSheetsConnection(): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Sheets connection test failed",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while testing sheets connection",
      };
    }
  }
  ...
  async saveSheetsConfig(config: any): Promise<ApiResponse<void>> {
    try {
      ...
      return {
        success: false,
        error: json.error || "Failed to save sheets configuration",
      };
    } catch (error) {
      return {
        success: false,
        error: "Network error while saving sheets configuration",
      };
    }
  }
