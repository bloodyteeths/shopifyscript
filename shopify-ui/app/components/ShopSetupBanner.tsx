...
export function ShopSetupBanner({
  onSetupComplete,
  showOnlyIfNeeded = true,
  allowDismiss = true,
}: ShopSetupBannerProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!validateShopName(trimmedShopName)) {
        setError(
          "Shop name must be 2-64 characters, alphanumeric with hyphens/underscores allowed",
        );
        return;
      }
            ...
            >
              ...
              <button
                ...
                style={{
                  padding: "12px 24px",
                  backgroundColor:
                    isLoading || !shopName.trim() ? "#6c757d" : "#28a745",
                  color: "white",
                  border: "none",
                  borderRadius: "6px",
                  fontSize: "16px",
                  fontWeight: "bold",
                  cursor:
                    isLoading || !shopName.trim() ? "not-allowed" : "pointer",
