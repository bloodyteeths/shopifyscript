    ...
    >
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#666", fontSize: "14px" }}>
              Automatically show "Only X left!" messages on low-stock products
              to create buying urgency.
            </p>
          </div>
      ...
      >
        ...
        <p style={{ fontSize: "18px", color: "#0c5460", marginBottom: "2rem" }}>
          ...
          <strong>Google Ads optimization</strong> first. Once that's delivering
          amazing results, we'll add these website optimization features.
        </p>
      ...
      >
        ...
        <ul style={{ color: "#666", lineHeight: "1.6", paddingLeft: "20px" }}>
          <li>
            <strong>Better Product:</strong> Perfect your Google Ads
            optimization first, then add website features
          </li>
          <li>
            <strong>Faster Launch:</strong> Get you making money sooner with
            proven Google Ads automation
          </li>
          <li>
            <strong>Customer-Driven:</strong> Build website features based on
            what you actually need
          </li>
          <li>
            <strong>Quality Focus:</strong> Each feature gets our full attention
